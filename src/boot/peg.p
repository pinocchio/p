(letrec ((car (lambda (cons) (cons 'car)))
       ...
       (Parser
            (newclass Parser Expression (expression semantics
                ...
                ((expression (s) ((getself s) 'objectAt: 3))
                 (expression: (s new) ((getself s) 'objectAt:put: 3 new))
                 (semantics (s) ((getself s) 'objectAt: 4))
                 (semantics: (s new) ((getself s) 'objectAt:put: 4 new))
                 (extendScope (s) ((getself s) 'objectAt: 5))
                 (extendScope: (s new) ((getself s) 'objectAt:put: 5 new))
                 (separator (s) ((getself s) 'objectAt: 6))
                 (separator: (s new) ((getself s) 'objectAt:put: 6 new))
                 (initialize: (s name)
                    (let ((self (getself s)))
                        (self 'name: name)
                        (self 'semantics: #f)
