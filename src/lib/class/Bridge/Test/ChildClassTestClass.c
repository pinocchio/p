...
static void init_SMB_b_() {
    ...
    Array PArray24686 = new_Array_with(1, (Optr)VAR_anObject_0_0);
    Assign PAssign24688 = new_Assign((Optr)slot_Bridge_Test_ChildClassTestClass_b, (Optr)VAR_anObject_0_0);
    Array PThreadedCode24687 = instantiate_Array_with(ThreadedCode_Class, 0, 7, (Optr)&t_push1, (Optr)PAssign24688, (Optr)&t_push_variable, (Optr)VAR_anObject_0_0, (Optr)&t_assign, (Optr)&t_zap, (Optr)&t_method_return_self);
    Method PMethod24685 = new_Method_with(PArray24686, empty_Array, empty_Array, PThreadedCode24687, 2, PAssign24688, self);
    
    MethodClosure MC_SMB_b_ = new_MethodClosure((Method)PMethod24685, Bridge_Test_ChildClassTestClass_Class);
...
static void init_SMB_b() {
    ...
    Array PThreadedCode24690 = instantiate_Array_with(ThreadedCode_Class, 0, 3, (Optr)&t_push_slot, (Optr)slot_Bridge_Test_ChildClassTestClass_b, (Optr)&t_method_return);
    Method PMethod24689 = new_Method_with(empty_Array, empty_Array, empty_Array, PThreadedCode24690, 1, slot_Bridge_Test_ChildClassTestClass_b);
    
    MethodClosure MC_SMB_b = new_MethodClosure((Method)PMethod24689, Bridge_Test_ChildClassTestClass_Class);
...
static void init_SMB_testSuper() {
    ...
    Super PSuper24693 = new_Super(SMB_test, 0);
    Constant int_10_Const = new_Constant((Optr)int_10);
    Symbol SMB__times_ = new_Symbol(L"*");
    // *. 
    Send PSend24694 = new_Send((Optr)int_10_Const, SMB__times_, 1, (Optr)PSuper24693);
    Array PThreadedCode24692 = instantiate_Array_with(ThreadedCode_Class, 0, 8, (Optr)&t_push1, (Optr)int_10, (Optr)&t_push_self, (Optr)&t_super0, (Optr)PSuper24693, (Optr)&t_send1, (Optr)PSend24694, (Optr)&t_method_return);
    Method PMethod24691 = new_Method_with(empty_Array, empty_Array, empty_Array, PThreadedCode24692, 1, PSend24694);
    
    MethodClosure MC_SMB_testSuper = new_MethodClosure((Method)PMethod24691, Bridge_Test_ChildClassTestClass_Class);
...
static void init_class_SMB_c() {
    ...
    Array PThreadedCode24696 = instantiate_Array_with(ThreadedCode_Class, 0, 3, (Optr)&t_push_slot, (Optr)slot_Bridge_Test_ChildClassTestClass_Class_class_c, (Optr)&t_method_return);
    Method PMethod24695 = new_Method_with(empty_Array, empty_Array, empty_Array, PThreadedCode24696, 1, slot_Bridge_Test_ChildClassTestClass_Class_class_c);
    
    MethodClosure MC_SMB_c = new_MethodClosure((Method)PMethod24695, HEADER(Bridge_Test_ChildClassTestClass_Class));
...
static void init_class_SMB_c_() {
    ...
    Variable VAR_anObject_0_0 = new_Variable_named(L"anObject", 0);
    Array PArray24698 = new_Array_with(1, (Optr)VAR_anObject_0_0);
    Assign PAssign24700 = new_Assign((Optr)slot_Bridge_Test_ChildClassTestClass_Class_class_c, (Optr)VAR_anObject_0_0);
    Array PThreadedCode24699 = instantiate_Array_with(ThreadedCode_Class, 0, 7, (Optr)&t_push1, (Optr)PAssign24700, (Optr)&t_push_variable, (Optr)VAR_anObject_0_0, (Optr)&t_assign, (Optr)&t_zap, (Optr)&t_method_return_self);
    Method PMethod24697 = new_Method_with(PArray24698, empty_Array, empty_Array, PThreadedCode24699, 2, PAssign24700, self);
    
    MethodClosure MC_SMB_c_ = new_MethodClosure((Method)PMethod24697, HEADER(Bridge_Test_ChildClassTestClass_Class));
