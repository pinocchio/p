...
static void init_SMB_b_() {
    ...
    Array PArray24905 = new_Array_with(1, (Optr)VAR_anObject_0_0);
    Assign PAssign24907 = new_Assign((Optr)slot_Bridge_Test_ChildClassTestClass_b, (Optr)VAR_anObject_0_0);
    Array PThreadedCode24906 = instantiate_Array_with(ThreadedCode_Class, 0, 7, (Optr)&t_push1, (Optr)PAssign24907, (Optr)&t_push_variable, (Optr)VAR_anObject_0_0, (Optr)&t_assign, (Optr)&t_zap, (Optr)&t_method_return_self);
    Method PMethod24904 = new_Method_with(PArray24905, empty_Array, empty_Array, PThreadedCode24906, 2, PAssign24907, self);
    
    MethodClosure MC_SMB_b_ = new_MethodClosure((Method)PMethod24904, Bridge_Test_ChildClassTestClass_Class);
...
static void init_SMB_b() {
    ...
    Array PThreadedCode24909 = instantiate_Array_with(ThreadedCode_Class, 0, 3, (Optr)&t_push_slot, (Optr)slot_Bridge_Test_ChildClassTestClass_b, (Optr)&t_method_return);
    Method PMethod24908 = new_Method_with(empty_Array, empty_Array, empty_Array, PThreadedCode24909, 1, slot_Bridge_Test_ChildClassTestClass_b);
    
    MethodClosure MC_SMB_b = new_MethodClosure((Method)PMethod24908, Bridge_Test_ChildClassTestClass_Class);
...
static void init_SMB_testSuper() {
    ...
    Super PSuper24912 = new_Super(SMB_test, 0);
    Constant int_10_Const = new_Constant((Optr)int_10);
    Symbol SMB__times_ = new_Symbol(L"*");
    // *. 
    Send PSend24913 = new_Send((Optr)int_10_Const, SMB__times_, 1, (Optr)PSuper24912);
    Array PThreadedCode24911 = instantiate_Array_with(ThreadedCode_Class, 0, 8, (Optr)&t_push1, (Optr)int_10, (Optr)&t_push_self, (Optr)&t_super0, (Optr)PSuper24912, (Optr)&t_send1, (Optr)PSend24913, (Optr)&t_method_return);
    Method PMethod24910 = new_Method_with(empty_Array, empty_Array, empty_Array, PThreadedCode24911, 1, PSend24913);
    
    MethodClosure MC_SMB_testSuper = new_MethodClosure((Method)PMethod24910, Bridge_Test_ChildClassTestClass_Class);
...
static void init_class_SMB_c() {
    ...
    Array PThreadedCode24915 = instantiate_Array_with(ThreadedCode_Class, 0, 3, (Optr)&t_push_slot, (Optr)slot_Bridge_Test_ChildClassTestClass_Class_class_c, (Optr)&t_method_return);
    Method PMethod24914 = new_Method_with(empty_Array, empty_Array, empty_Array, PThreadedCode24915, 1, slot_Bridge_Test_ChildClassTestClass_Class_class_c);
    
    MethodClosure MC_SMB_c = new_MethodClosure((Method)PMethod24914, HEADER(Bridge_Test_ChildClassTestClass_Class));
...
static void init_class_SMB_c_() {
    ...
    Variable VAR_anObject_0_0 = new_Variable_named(L"anObject", 0);
    Array PArray24917 = new_Array_with(1, (Optr)VAR_anObject_0_0);
    Assign PAssign24919 = new_Assign((Optr)slot_Bridge_Test_ChildClassTestClass_Class_class_c, (Optr)VAR_anObject_0_0);
    Array PThreadedCode24918 = instantiate_Array_with(ThreadedCode_Class, 0, 7, (Optr)&t_push1, (Optr)PAssign24919, (Optr)&t_push_variable, (Optr)VAR_anObject_0_0, (Optr)&t_assign, (Optr)&t_zap, (Optr)&t_method_return_self);
    Method PMethod24916 = new_Method_with(PArray24917, empty_Array, empty_Array, PThreadedCode24918, 2, PAssign24919, self);
    
    MethodClosure MC_SMB_c_ = new_MethodClosure((Method)PMethod24916, HEADER(Bridge_Test_ChildClassTestClass_Class));
