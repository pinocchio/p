...
static void init_SMB_next() {
    ...
    Array PThreadedCode18195 = instantiate_Array_with(ThreadedCode_Class, 0, 3, (Optr)&t_push_slot, (Optr)slot_Shell_ReadLine_StartLink_next, (Optr)&t_method_return);
    Method PMethod18194 = new_Method_with(empty_Array, empty_Array, empty_Array, PThreadedCode18195, 1, slot_Shell_ReadLine_StartLink_next);
    
    MethodClosure MC_SMB_next = new_MethodClosure((Method)PMethod18194, Shell_ReadLine_StartLink_Class);
...
static void init_SMB_next_() {
    ...
    Array PArray18197 = new_Array_with(1, (Optr)VAR_anObject_0_0);
    Assign PAssign18199 = new_Assign((Optr)slot_Shell_ReadLine_StartLink_next, (Optr)VAR_anObject_0_0);
    Symbol SMB_previous_ = new_Symbol(L"previous:");
    // previous:. 
    Send PSend18200 = new_Send((Optr)VAR_anObject_0_0, SMB_previous_, 1, (Optr)self);
    Array PThreadedCode18198 = instantiate_Array_with(ThreadedCode_Class, 0, 13, (Optr)&t_push1, (Optr)PAssign18199, (Optr)&t_push_variable, (Optr)VAR_anObject_0_0, (Optr)&t_assign, (Optr)&t_zap, (Optr)&t_push_variable, (Optr)VAR_anObject_0_0, (Optr)&t_push_self, (Optr)&t_send1, (Optr)PSend18200, (Optr)&t_zap, (Optr)&t_method_return_self);
    Method PMethod18196 = new_Method_with(PArray18197, empty_Array, empty_Array, PThreadedCode18198, 3, PAssign18199, PSend18200, self);
    
    MethodClosure MC_SMB_next_ = new_MethodClosure((Method)PMethod18196, Shell_ReadLine_StartLink_Class);
...
static void init_SMB_previous() {
    ...
    Array PThreadedCode18202 = instantiate_Array_with(ThreadedCode_Class, 0, 1, (Optr)&t_method_return_self);
    Method PMethod18201 = new_Method_with(empty_Array, empty_Array, empty_Array, PThreadedCode18202, 1, self);
    
    MethodClosure MC_SMB_previous = new_MethodClosure((Method)PMethod18201, Shell_ReadLine_StartLink_Class);
