...
static void init_SMB_accept_() {
    ...
    Array PArray15376 = new_Array_with(1, (Optr)VAR_visitor_0_0);
    Symbol SMB_visitUnarySelector_ = new_Symbol(L"visitUnarySelector:");
    // visitUnarySelector:. 
    Send PSend15378 = new_Send((Optr)VAR_visitor_0_0, SMB_visitUnarySelector_, 1, (Optr)self);
    Array PThreadedCode15377 = instantiate_Array_with(ThreadedCode_Class, 0, 6, (Optr)&t_push_variable, (Optr)VAR_visitor_0_0, (Optr)&t_push_self, (Optr)&t_send1, (Optr)PSend15378, (Optr)&t_method_return);
    Method PMethod15375 = new_Method_with(PArray15376, empty_Array, empty_Array, PThreadedCode15377, 1, PSend15378);
    
    MethodClosure MC_SMB_accept_ = new_MethodClosure((Method)PMethod15375, Smalltalk_AST_UnarySelector_Class);
