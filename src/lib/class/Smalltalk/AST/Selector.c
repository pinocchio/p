...
<<<<<<< HEAD
    Array PThreadedCode15303 = instantiate_Array_with(ThreadedCode_Class, 0, 3, (Optr)&t_push_slot, (Optr)slot_Smalltalk_AST_Selector_selector, (Optr)&t_method_return);
    Method PMethod15302 = new_Method_with(empty_Array, empty_Array, empty_Array, PThreadedCode15303, 1, slot_Smalltalk_AST_Selector_selector);
    
    MethodClosure MC_SMB_selector = new_MethodClosure((Method)PMethod15302, Smalltalk_AST_Selector_Class);
=======
...
<<<<<<< HEAD
    Array PArray15305 = new_Array_with(1, (Optr)VAR_anObject_0_0);
    Symbol SMB_asSymbol = new_Symbol(L"asSymbol");
    // asSymbol. 
    Send PSend15308 = new_Send((Optr)VAR_anObject_0_0, SMB_asSymbol, 0);
    Assign PAssign15307 = new_Assign((Optr)slot_Smalltalk_AST_Selector_selector, (Optr)PSend15308);
    Array PThreadedCode15306 = instantiate_Array_with(ThreadedCode_Class, 0, 9, (Optr)&t_push1, (Optr)PAssign15307, (Optr)&t_push_variable, (Optr)VAR_anObject_0_0, (Optr)&t_send0, (Optr)PSend15308, (Optr)&t_assign, (Optr)&t_zap, (Optr)&t_method_return_self);
    Method PMethod15304 = new_Method_with(PArray15305, empty_Array, empty_Array, PThreadedCode15306, 2, PAssign15307, self);
    
    MethodClosure MC_SMB_selector_ = new_MethodClosure((Method)PMethod15304, Smalltalk_AST_Selector_Class);
=======
...
<<<<<<< HEAD
    Array PArray15310 = new_Array_with(1, (Optr)VAR_other_0_0);
    Variable VAR__return__1_0 = new_Variable_named(L"_return_", 1);
    Array PArray15313 = new_Array_with(1, (Optr)VAR__return__1_0);
    Super PSuper15315 = new_Super(SMB__equals_, 1, (Optr)VAR_other_0_0);
    Symbol SMB_ifFalse_ = new_Symbol(L"ifFalse:");
    Symbol SMB_escape_ = new_Symbol(L"escape:");
    // escape:. 
    Send PSend15319 = new_Send((Optr)VAR__return__1_0, SMB_escape_, 1, (Optr)false_Const);
    Array PThreadedCode15318 = instantiate_Array_with(ThreadedCode_Class, 0, 6, (Optr)&t_push_variable, (Optr)VAR__return__1_0, (Optr)&t_push_false, (Optr)&t_send1, (Optr)PSend15319, (Optr)&t_block_return);
    Block PBlock15317 = new_Block_with(empty_Array, empty_Array, PThreadedCode15318, 1, PSend15319);
    // ifFalse:. 
    Send PSend15316 = new_Send((Optr)PSuper15315, SMB_ifFalse_, 1, (Optr)PBlock15317);
    Symbol SMB_selector = new_Symbol(L"selector");
    // selector. 
    Send PSend15320 = new_Send((Optr)VAR_other_0_0, SMB_selector, 0);
    // =. 
    Send PSend15321 = new_Send((Optr)slot_Smalltalk_AST_Selector_selector, SMB__equals_, 1, (Optr)PSend15320);
    Array PThreadedCode15314 = instantiate_Array_with(ThreadedCode_Class, 0, 18, (Optr)&t_push_self, (Optr)&t_push_variable, (Optr)VAR_other_0_0, (Optr)&t_super1, (Optr)PSuper15315, (Optr)&t_send_ifFalse_, (Optr)PSend15316, (Optr)PBlock15317, (Optr)&t_zap, (Optr)&t_push_slot, (Optr)slot_Smalltalk_AST_Selector_selector, (Optr)&t_push_variable, (Optr)VAR_other_0_0, (Optr)&t_send0, (Optr)PSend15320, (Optr)&t_send1, (Optr)PSend15321, (Optr)&t_method_return);
    Block PBlock15312 = new_Block_with(PArray15313, empty_Array, PThreadedCode15314, 2, PSend15316, PSend15321);
    Symbol SMB_on_ = new_Symbol(L"on:");
    // on:. 
    Send PSend15322 = new_Send((Optr)PContinue_classReference, SMB_on_, 1, (Optr)PBlock15312);
    Array PThreadedCode15311 = instantiate_Array_with(ThreadedCode_Class, 0, 7, (Optr)&t_push_class_reference, (Optr)PContinue_classReference, (Optr)&t_push_closure, (Optr)PBlock15312, (Optr)&t_send1, (Optr)PSend15322, (Optr)&t_method_return);
    Method PMethod15309 = new_Method_with(PArray15310, empty_Array, empty_Array, PThreadedCode15311, 1, PSend15322);
    
    MethodClosure MC_SMB__equals_ = new_MethodClosure((Method)PMethod15309, Smalltalk_AST_Selector_Class);
=======
...
static void init_SMB_parameters() {
    ...
    // new. 
<<<<<<< HEAD
    Send PSend15325 = new_Send((Optr)Array_classReference, SMB_new, 0);
    Array PThreadedCode15324 = instantiate_Array_with(ThreadedCode_Class, 0, 5, (Optr)&t_push_class_reference, (Optr)Array_classReference, (Optr)&t_send0, (Optr)PSend15325, (Optr)&t_method_return);
    Method PMethod15323 = new_Method_with(empty_Array, empty_Array, empty_Array, PThreadedCode15324, 1, PSend15325);
    
    MethodClosure MC_SMB_parameters = new_MethodClosure((Method)PMethod15323, Smalltalk_AST_Selector_Class);
=======
...
<<<<<<< HEAD
    Array PArray15327 = new_Array_with(1, (Optr)VAR_stream_0_0);
    Symbol SMB__shiftLeft_ = new_Symbol(L"<<");
    // <<. 
    Send PSend15329 = new_Send((Optr)VAR_stream_0_0, SMB__shiftLeft_, 1, (Optr)slot_Smalltalk_AST_Selector_selector);
    Array PThreadedCode15328 = instantiate_Array_with(ThreadedCode_Class, 0, 8, (Optr)&t_push_variable, (Optr)VAR_stream_0_0, (Optr)&t_push_slot, (Optr)slot_Smalltalk_AST_Selector_selector, (Optr)&t_send1, (Optr)PSend15329, (Optr)&t_zap, (Optr)&t_method_return_self);
    Method PMethod15326 = new_Method_with(PArray15327, empty_Array, empty_Array, PThreadedCode15328, 2, PSend15329, self);
    
    MethodClosure MC_SMB_printOn_ = new_MethodClosure((Method)PMethod15326, Smalltalk_AST_Selector_Class);
=======
...
static void init_class_SMB_astSelectors() {
    ...
    // with:. 
<<<<<<< HEAD
    Send PSend15332 = new_Send((Optr)Array_classReference, SMB_with_, 1, (Optr)SMB_selector_Const);
    Array PThreadedCode15331 = instantiate_Array_with(ThreadedCode_Class, 0, 7, (Optr)&t_push_class_reference, (Optr)Array_classReference, (Optr)&t_push1, (Optr)SMB_selector, (Optr)&t_send1, (Optr)PSend15332, (Optr)&t_method_return);
    Method PMethod15330 = new_Method_with(empty_Array, empty_Array, empty_Array, PThreadedCode15331, 1, PSend15332);
    
    MethodClosure MC_SMB_astSelectors = new_MethodClosure((Method)PMethod15330, HEADER(Smalltalk_AST_Selector_Class));
=======
