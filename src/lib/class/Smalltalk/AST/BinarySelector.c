...
static void init_SMB_accept_() {
    ...
    Array PArray15680 = new_Array_with(1, (Optr)VAR_visitor_0_0);
    Symbol SMB_visitBinarySelector_ = new_Symbol(L"visitBinarySelector:");
    // visitBinarySelector:. 
    Send PSend15682 = new_Send((Optr)VAR_visitor_0_0, SMB_visitBinarySelector_, 1, (Optr)self);
    Array PThreadedCode15681 = instantiate_Array_with(ThreadedCode_Class, 0, 6, (Optr)&t_push_variable, (Optr)VAR_visitor_0_0, (Optr)&t_push_self, (Optr)&t_send1, (Optr)PSend15682, (Optr)&t_method_return);
    Method PMethod15679 = new_Method_with(PArray15680, empty_Array, empty_Array, PThreadedCode15681, 1, PSend15682);
    
    MethodClosure MC_SMB_accept_ = new_MethodClosure((Method)PMethod15679, Smalltalk_AST_BinarySelector_Class);
