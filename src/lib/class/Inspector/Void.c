...
static void init_SMB_inspect() {
    ...
    */
    ...
    Array PThreadedCode12166 = instantiate_Array_with(ThreadedCode_Class, 0, 1, (Optr)&t_method_return_self);
    Method PMethod12165 = new_Method_with(empty_Array, empty_Array, empty_Array, PThreadedCode12166, 1, self);
    
    MethodClosure MC_SMB_inspect = new_MethodClosure((Method)PMethod12165, Inspector_Void_Class);
...
static void init_SMB_doesNotUnderstand_() {
    ...
    Array PArray12168 = new_Array_with(1, (Optr)VAR_aMessage_0_0);
    Array PThreadedCode12169 = instantiate_Array_with(ThreadedCode_Class, 0, 1, (Optr)&t_method_return_self);
    Method PMethod12167 = new_Method_with(PArray12168, empty_Array, empty_Array, PThreadedCode12169, 1, self);
    
    MethodClosure MC_SMB_doesNotUnderstand_ = new_MethodClosure((Method)PMethod12167, Inspector_Void_Class);
...
static void init_class_SMB_inspect() {
    Symbol SMB_inspect = new_Symbol(L"inspect");
    Array PThreadedCode12171 = instantiate_Array_with(ThreadedCode_Class, 0, 1, (Optr)&t_method_return_self);
    Method PMethod12170 = new_Method_with(empty_Array, empty_Array, empty_Array, PThreadedCode12171, 1, self);
    
    MethodClosure MC_SMB_inspect = new_MethodClosure((Method)PMethod12170, HEADER(Inspector_Void_Class));
