...
static void init_SMB_inspect() {
    ...
    */
    ...
    Array PThreadedCode12093 = instantiate_Array_with(ThreadedCode_Class, 0, 1, (Optr)&t_method_return_self);
    Method PMethod12092 = new_Method_with(empty_Array, empty_Array, empty_Array, PThreadedCode12093, 1, self);
    
    MethodClosure MC_SMB_inspect = new_MethodClosure((Method)PMethod12092, Inspector_Void_Class);
...
static void init_SMB_doesNotUnderstand_() {
    ...
    Array PArray12095 = new_Array_with(1, (Optr)VAR_aMessage_0_0);
    Array PThreadedCode12096 = instantiate_Array_with(ThreadedCode_Class, 0, 1, (Optr)&t_method_return_self);
    Method PMethod12094 = new_Method_with(PArray12095, empty_Array, empty_Array, PThreadedCode12096, 1, self);
    
    MethodClosure MC_SMB_doesNotUnderstand_ = new_MethodClosure((Method)PMethod12094, Inspector_Void_Class);
...
static void init_class_SMB_inspect() {
    Symbol SMB_inspect = new_Symbol(L"inspect");
    Array PThreadedCode12098 = instantiate_Array_with(ThreadedCode_Class, 0, 1, (Optr)&t_method_return_self);
    Method PMethod12097 = new_Method_with(empty_Array, empty_Array, empty_Array, PThreadedCode12098, 1, self);
    
    MethodClosure MC_SMB_inspect = new_MethodClosure((Method)PMethod12097, HEADER(Inspector_Void_Class));
