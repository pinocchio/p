...
static void init_SMB_printOn_() {
    ...
    // indexOf:. 
    Send PSend6960 = new_Send((Optr)VAR_total_0_3, SMB_indexOf_, 1, (Optr)char_2907_Const);
    // -. 
...
static void init_SMB_gaussianConfidenceFactor() {
    ...
    Array PThreadedCode6976 = instantiate_Array_with(ThreadedCode_Class, 0, 3, (Optr)&t_push1, (Optr)float_1_644853626951, (Optr)&t_method_return);
    Constant float_1_644853626951_Const = new_Constant((Optr)float_1_644853626951);
    Method PMethod6975 = new_Method_with(empty_Array, empty_Array, empty_Array, PThreadedCode6976, 1, float_1_644853626951_Const);
    
    MethodClosure MC_SMB_gaussianConfidenceFactor = new_MethodClosure((Method)PMethod6975, PBenchmark_AbstractBenchmark_Class);
...
static void init_SMB_probeCount() {
    Symbol SMB_probeCount = new_Symbol(L"probeCount");
    Array PThreadedCode6978 = instantiate_Array_with(ThreadedCode_Class, 0, 3, (Optr)&t_push_slot, (Optr)slot_PBenchmark_AbstractBenchmark_probeCount, (Optr)&t_method_return);
    Method PMethod6977 = new_Method_with(empty_Array, empty_Array, empty_Array, PThreadedCode6978, 1, slot_PBenchmark_AbstractBenchmark_probeCount);
    
    MethodClosure MC_SMB_probeCount = new_MethodClosure((Method)PMethod6977, PBenchmark_AbstractBenchmark_Class);
...
static void init_SMB_significantDigits() {
    ...
    Array PArray6980 = new_Array_with(1, (Optr)VAR_variance_0_0);
    Variable VAR__return__1_0 = new_Variable_named(L"_return_", 1);
    Array PArray6983 = new_Array_with(1, (Optr)VAR__return__1_0);
    Symbol SMB_confidenceVariance = new_Symbol(L"confidenceVariance");
    // confidenceVariance. 
    Send PSend6986 = new_Send((Optr)self, SMB_confidenceVariance, 0);
    Assign PAssign6985 = new_Assign((Optr)VAR_variance_0_0, (Optr)PSend6986);
    Symbol SMB__equals_ = new_Symbol(L"=");
    SmallInt int_0 = new_SmallInt(0);
    Constant int_0_Const = new_Constant((Optr)int_0);
    // =. 
    Send PSend6987 = new_Send((Optr)VAR_variance_0_0, SMB__equals_, 1, (Optr)int_0_Const);
    Symbol SMB_ifTrue_ = new_Symbol(L"ifTrue:");
    Symbol SMB_escape_ = new_Symbol(L"escape:");
    SmallInt int_2 = new_SmallInt(2);
    Constant int_2_Const = new_Constant((Optr)int_2);
    // escape:. 
    Send PSend6991 = new_Send((Optr)VAR__return__1_0, SMB_escape_, 1, (Optr)int_2_Const);
    Array PThreadedCode6990 = instantiate_Array_with(ThreadedCode_Class, 0, 6, (Optr)&t_push_variable, (Optr)VAR__return__1_0, (Optr)&t_push_2, (Optr)&t_send1, (Optr)PSend6991, (Optr)&t_block_return);
    Block PBlock6989 = new_Block_with(empty_Array, empty_Array, PThreadedCode6990, 1, PSend6991);
    // ifTrue:. 
    Send PSend6988 = new_Send((Optr)PSend6987, SMB_ifTrue_, 1, (Optr)PBlock6989);
    SmallInt int_10 = new_SmallInt(10);
    Symbol SMB__gt__equals_ = new_Symbol(L">=");
    Constant int_10_Const = new_Constant((Optr)int_10);
    // >=. 
    Send PSend6992 = new_Send((Optr)VAR_variance_0_0, SMB__gt__equals_, 1, (Optr)int_10_Const);
    // escape:. 
    Send PSend6996 = new_Send((Optr)VAR__return__1_0, SMB_escape_, 1, (Optr)int_0_Const);
    Array PThreadedCode6995 = instantiate_Array_with(ThreadedCode_Class, 0, 6, (Optr)&t_push_variable, (Optr)VAR__return__1_0, (Optr)&t_push_0, (Optr)&t_send1, (Optr)PSend6996, (Optr)&t_block_return);
    Block PBlock6994 = new_Block_with(empty_Array, empty_Array, PThreadedCode6995, 1, PSend6996);
    // ifTrue:. 
    Send PSend6993 = new_Send((Optr)PSend6992, SMB_ifTrue_, 1, (Optr)PBlock6994);
    Symbol SMB_log = new_Symbol(L"log");
    // log. 
    Send PSend6997 = new_Send((Optr)VAR_variance_0_0, SMB_log, 0);
    Symbol SMB_floor = new_Symbol(L"floor");
    // floor. 
    Send PSend6998 = new_Send((Optr)PSend6997, SMB_floor, 0);
    SmallInt int_1 = new_SmallInt(1);
    Constant int_1_Const = new_Constant((Optr)int_1);
    Symbol SMB__minus_ = new_Symbol(L"-");
    // -. 
    Send PSend6999 = new_Send((Optr)int_1_Const, SMB__minus_, 1, (Optr)PSend6998);
    Array PThreadedCode6984 = instantiate_Array_with(ThreadedCode_Class, 0, 36, (Optr)&t_push1, (Optr)PAssign6985, (Optr)&t_push_self, (Optr)&t_send0, (Optr)PSend6986, (Optr)&t_assign, (Optr)&t_zap, (Optr)&t_push_variable, (Optr)VAR_variance_0_0, (Optr)&t_push_0, (Optr)&t_send1, (Optr)PSend6987, (Optr)&t_send_ifTrue_, (Optr)PSend6988, (Optr)PBlock6989, (Optr)&t_zap, (Optr)&t_push_variable, (Optr)VAR_variance_0_0, (Optr)&t_push1, (Optr)int_10, (Optr)&t_send1, (Optr)PSend6992, (Optr)&t_send_ifTrue_, (Optr)PSend6993, (Optr)PBlock6994, (Optr)&t_zap, (Optr)&t_push_1, (Optr)&t_push_variable, (Optr)VAR_variance_0_0, (Optr)&t_send0, (Optr)PSend6997, (Optr)&t_send0, (Optr)PSend6998, (Optr)&t_send1, (Optr)PSend6999, (Optr)&t_method_return);
    Block PBlock6982 = new_Block_with(PArray6983, empty_Array, PThreadedCode6984, 4, PAssign6985, PSend6988, PSend6993, PSend6999);
    Symbol SMB_on_ = new_Symbol(L"on:");
    // on:. 
    Send PSend7000 = new_Send((Optr)PContinue_classReference, SMB_on_, 1, (Optr)PBlock6982);
    Array PThreadedCode6981 = instantiate_Array_with(ThreadedCode_Class, 0, 7, (Optr)&t_push_class_reference, (Optr)PContinue_classReference, (Optr)&t_push_closure, (Optr)PBlock6982, (Optr)&t_send1, (Optr)PSend7000, (Optr)&t_method_return);
    Method PMethod6979 = new_Method_with(empty_Array, PArray6980, empty_Array, PThreadedCode6981, 1, PSend7000);
    
    MethodClosure MC_SMB_significantDigits = new_MethodClosure((Method)PMethod6979, PBenchmark_AbstractBenchmark_Class);
...
static void init_SMB_probeCount_() {
    ...
    Array PArray7002 = new_Array_with(1, (Optr)VAR_anObject_0_0);
    Assign PAssign7004 = new_Assign((Optr)slot_PBenchmark_AbstractBenchmark_probeCount, (Optr)VAR_anObject_0_0);
    Array PThreadedCode7003 = instantiate_Array_with(ThreadedCode_Class, 0, 7, (Optr)&t_push1, (Optr)PAssign7004, (Optr)&t_push_variable, (Optr)VAR_anObject_0_0, (Optr)&t_assign, (Optr)&t_zap, (Optr)&t_method_return_self);
    Method PMethod7001 = new_Method_with(PArray7002, empty_Array, empty_Array, PThreadedCode7003, 2, PAssign7004, self);
    
    MethodClosure MC_SMB_probeCount_ = new_MethodClosure((Method)PMethod7001, PBenchmark_AbstractBenchmark_Class);
