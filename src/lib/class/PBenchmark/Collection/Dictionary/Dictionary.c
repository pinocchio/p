...
static void init_SMB_setUp() {
    ...
    Super PSuper24954 = new_Super(SMB_setUp, 0);
    Symbol SMB_new_ = new_Symbol(L"new:");
    Symbol SMB_dictSize = new_Symbol(L"dictSize");
    // dictSize. 
    Send PSend24957 = new_Send((Optr)self, SMB_dictSize, 0);
    // new:. 
    Send PSend24956 = new_Send((Optr)Dictionary_classReference, SMB_new_, 1, (Optr)PSend24957);
    Assign PAssign24955 = new_Assign((Optr)slot_PBenchmark_Collection_Dictionary_AbstractDictionary_dict, (Optr)PSend24956);
    // dictSize. 
    Send PSend24958 = new_Send((Optr)self, SMB_dictSize, 0);
    Variable VAR_i_1_0 = new_Variable_named(L"i", 1);
    Array PArray24960 = new_Array_with(1, (Optr)VAR_i_1_0);
    Symbol SMB_key_ = new_Symbol(L"key:");
    // key:. 
    Send PSend24962 = new_Send((Optr)self, SMB_key_, 1, (Optr)VAR_i_1_0);
    Symbol SMB_value_ = new_Symbol(L"value:");
    // value:. 
    Send PSend24963 = new_Send((Optr)self, SMB_value_, 1, (Optr)VAR_i_1_0);
    Symbol SMB_at_put_ = new_Symbol(L"at:put:");
    // at:put:. 
    Send PSend24964 = new_Send((Optr)slot_PBenchmark_Collection_Dictionary_AbstractDictionary_dict, SMB_at_put_, 2, (Optr)PSend24962, (Optr)PSend24963);
    Array PThreadedCode24961 = instantiate_Array_with(ThreadedCode_Class, 0, 15, (Optr)&t_push_slot, (Optr)slot_PBenchmark_Collection_Dictionary_AbstractDictionary_dict, (Optr)&t_push_self, (Optr)&t_push_variable, (Optr)VAR_i_1_0, (Optr)&t_send1, (Optr)PSend24962, (Optr)&t_push_self, (Optr)&t_push_variable, (Optr)VAR_i_1_0, (Optr)&t_send1, (Optr)PSend24963, (Optr)&t_send2, (Optr)PSend24964, (Optr)&t_method_return);
    Block PBlock24959 = new_Block_with(PArray24960, empty_Array, PThreadedCode24961, 1, PSend24964);
    SmallInt int_1 = new_SmallInt(1);
    Constant int_1_Const = new_Constant((Optr)int_1);
    Symbol SMB_to_do_ = new_Symbol(L"to:do:");
    // to:do:. 
    Send PSend24965 = new_Send((Optr)int_1_Const, SMB_to_do_, 2, (Optr)PSend24958, (Optr)PBlock24959);
    Array PThreadedCode24953 = instantiate_Array_with(ThreadedCode_Class, 0, 26, (Optr)&t_push_self, (Optr)&t_super0, (Optr)PSuper24954, (Optr)&t_zap, (Optr)&t_push1, (Optr)PAssign24955, (Optr)&t_push_class_reference, (Optr)Dictionary_classReference, (Optr)&t_push_self, (Optr)&t_send0, (Optr)PSend24957, (Optr)&t_send1, (Optr)PSend24956, (Optr)&t_assign, (Optr)&t_zap, (Optr)&t_push_1, (Optr)&t_push_self, (Optr)&t_send0, (Optr)PSend24958, (Optr)&t_push_closure, (Optr)PBlock24959, (Optr)&t_send_to_do_, (Optr)&t_continue_to_do_, (Optr)PSend24965, (Optr)&t_zap, (Optr)&t_method_return_self);
    Method PMethod24952 = new_Method_with(empty_Array, empty_Array, empty_Array, PThreadedCode24953, 4, PSuper24954, PAssign24955, PSend24965, self);
    
    MethodClosure MC_SMB_setUp = new_MethodClosure((Method)PMethod24952, PBenchmark_Collection_Dictionary_Dictionary_Class);
