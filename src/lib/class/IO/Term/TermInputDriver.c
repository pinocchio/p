...
static void init_SMB_initializeSS3_() {
    ...
    // at:put:. 
    Send PSend9118 = new_Send((Optr)VAR_actions_0_0, SMB_at_put_, 2, (Optr)char_8532_Const, (Optr)PBlock9115);
...
static void init_SMB_readC1() {
    ...
    // =. 
    Send PSend9172 = new_Send((Optr)VAR_character_0_0, SMB__equals_, 1, (Optr)char_8450_Const);
    ...
    // =. 
    Send PSend9178 = new_Send((Optr)VAR_character_0_0, SMB__equals_, 1, (Optr)char_8823_Const);
...
static void init_SMB_initializeCSI_() {
    ...
    // at:put:. 
    Send PSend9287 = new_Send((Optr)VAR_actions_0_0, SMB_at_put_, 2, (Optr)char_8573_Const, (Optr)PBlock9284);
    ...
    // at:put:. 
    Send PSend9301 = new_Send((Optr)VAR_actions_0_0, SMB_at_put_, 2, (Optr)char_8504_Const, (Optr)PBlock9298);
