...
static void init_class_SMB_ifMatched_() {
    ...
    Array PArray19902 = new_Array_with(1, (Optr)VAR_block_0_0);
    Array PThreadedCode19903 = instantiate_Array_with(ThreadedCode_Class, 0, 1, (Optr)&t_method_return_self);
    Method PMethod19901 = new_Method_with(PArray19902, empty_Array, empty_Array, PThreadedCode19903, 1, self);
    
    MethodClosure MC_SMB_ifMatched_ = new_MethodClosure((Method)PMethod19901, HEADER(PEG_FailedOptionalResult_Class));
...
static void init_class_SMB_ifMatched_ifFailed_() {
    ...
    Array PArray19905 = new_Array_with(2, (Optr)VAR_block_0_0, (Optr)VAR_alternative_0_1);
    Symbol SMB_value = new_Symbol(L"value");
    // value. 
    Send PSend19907 = new_Send((Optr)VAR_alternative_0_1, SMB_value, 0);
    Array PThreadedCode19906 = instantiate_Array_with(ThreadedCode_Class, 0, 5, (Optr)&t_push_variable, (Optr)VAR_alternative_0_1, (Optr)&t_send0, (Optr)PSend19907, (Optr)&t_method_return);
    Method PMethod19904 = new_Method_with(PArray19905, empty_Array, empty_Array, PThreadedCode19906, 1, PSend19907);
    
    MethodClosure MC_SMB_ifMatched_ifFailed_ = new_MethodClosure((Method)PMethod19904, HEADER(PEG_FailedOptionalResult_Class));
...
// 		ifFalse: [self error: 'A Metaclass should only have one instance!']
    */
    ...
    Array PThreadedCode19909 = instantiate_Array_with(ThreadedCode_Class, 0, 1, (Optr)&t_method_return_self);
    Method PMethod19908 = new_Method_with(empty_Array, empty_Array, empty_Array, PThreadedCode19909, 1, self);
    
    MethodClosure MC_SMB_new = new_MethodClosure((Method)PMethod19908, HEADER(PEG_FailedOptionalResult_Class));
...
static void init_class_SMB_resultIfFailed_() {
    ...
    Array PArray19911 = new_Array_with(1, (Optr)VAR_alternative_0_0);
    Symbol SMB_value = new_Symbol(L"value");
    // value. 
    Send PSend19913 = new_Send((Optr)VAR_alternative_0_0, SMB_value, 0);
    Array PThreadedCode19912 = instantiate_Array_with(ThreadedCode_Class, 0, 5, (Optr)&t_push_variable, (Optr)VAR_alternative_0_0, (Optr)&t_send0, (Optr)PSend19913, (Optr)&t_method_return);
    Method PMethod19910 = new_Method_with(PArray19911, empty_Array, empty_Array, PThreadedCode19912, 1, PSend19913);
    
    MethodClosure MC_SMB_resultIfFailed_ = new_MethodClosure((Method)PMethod19910, HEADER(PEG_FailedOptionalResult_Class));
