...
<<<<<<< HEAD
    Array PArray19054 = new_Array_with(1, (Optr)VAR_aSeparator_0_0);
    Assign PAssign19056 = new_Assign((Optr)slot_PEG_Parser_separator, (Optr)VAR_aSeparator_0_0);
    Array PThreadedCode19055 = instantiate_Array_with(ThreadedCode_Class, 0, 7, (Optr)&t_push1, (Optr)PAssign19056, (Optr)&t_push_variable, (Optr)VAR_aSeparator_0_0, (Optr)&t_assign, (Optr)&t_zap, (Optr)&t_method_return_self);
    Method PMethod19053 = new_Method_with(PArray19054, empty_Array, empty_Array, PThreadedCode19055, 2, PAssign19056, self);
    
    MethodClosure MC_SMB_separator_ = new_MethodClosure((Method)PMethod19053, PEG_Parser_Class);
=======
...
static void init_SMB_memo() {
    ...
    // on:. 
<<<<<<< HEAD
    Send PSend19059 = new_Send((Optr)PEGMemo_classReference, SMB_on_, 1, (Optr)self);
    Array PThreadedCode19058 = instantiate_Array_with(ThreadedCode_Class, 0, 6, (Optr)&t_push_class_reference, (Optr)PEGMemo_classReference, (Optr)&t_push_self, (Optr)&t_send1, (Optr)PSend19059, (Optr)&t_method_return);
    Method PMethod19057 = new_Method_with(empty_Array, empty_Array, empty_Array, PThreadedCode19058, 1, PSend19059);
    
    MethodClosure MC_SMB_memo = new_MethodClosure((Method)PMethod19057, PEG_Parser_Class);
=======
...
<<<<<<< HEAD
    Array PThreadedCode19061 = instantiate_Array_with(ThreadedCode_Class, 0, 3, (Optr)&t_push_slot, (Optr)slot_PEG_Parser_expression, (Optr)&t_method_return);
    Method PMethod19060 = new_Method_with(empty_Array, empty_Array, empty_Array, PThreadedCode19061, 1, slot_PEG_Parser_expression);
    
    MethodClosure MC_SMB_expression = new_MethodClosure((Method)PMethod19060, PEG_Parser_Class);
=======
...
static void init_SMB_initialize() {
    ...
    // class. 
<<<<<<< HEAD
    Send PSend19066 = new_Send((Optr)self, SMB_class, 0);
    Symbol SMB_separator = new_Symbol(L"separator");
    // separator. 
    Send PSend19065 = new_Send((Optr)PSend19066, SMB_separator, 0);
    Assign PAssign19064 = new_Assign((Optr)slot_PEG_Parser_separator, (Optr)PSend19065);
    Assign PAssign19067 = new_Assign((Optr)slot_PEG_Parser_semantics, (Optr)nil_Const);
    Array PThreadedCode19063 = instantiate_Array_with(ThreadedCode_Class, 0, 15, (Optr)&t_push1, (Optr)PAssign19064, (Optr)&t_push_self, (Optr)&t_send0, (Optr)PSend19066, (Optr)&t_send0, (Optr)PSend19065, (Optr)&t_assign, (Optr)&t_zap, (Optr)&t_push1, (Optr)PAssign19067, (Optr)&t_push_nil, (Optr)&t_assign, (Optr)&t_zap, (Optr)&t_method_return_self);
    Method PMethod19062 = new_Method_with(empty_Array, empty_Array, empty_Array, PThreadedCode19063, 3, PAssign19064, PAssign19067, self);
    
    MethodClosure MC_SMB_initialize = new_MethodClosure((Method)PMethod19062, PEG_Parser_Class);
=======
...
<<<<<<< HEAD
    Array PArray19069 = new_Array_with(1, (Optr)VAR_input_0_0);
    Variable VAR__return__1_0 = new_Variable_named(L"_return_", 1);
    Array PArray19072 = new_Array_with(1, (Optr)VAR__return__1_0);
    // parseOn:. 
    Send PSend19074 = new_Send((Optr)slot_PEG_Parser_expression, SMB_parseOn_, 1, (Optr)VAR_input_0_0);
    Symbol SMB_ifFalse_ = new_Symbol(L"ifFalse:");
    Symbol SMB_escape_ = new_Symbol(L"escape:");
    // escape:. 
    Send PSend19078 = new_Send((Optr)VAR__return__1_0, SMB_escape_, 1, (Optr)false_Const);
    Array PThreadedCode19077 = instantiate_Array_with(ThreadedCode_Class, 0, 6, (Optr)&t_push_variable, (Optr)VAR__return__1_0, (Optr)&t_push_false, (Optr)&t_send1, (Optr)PSend19078, (Optr)&t_block_return);
    Block PBlock19076 = new_Block_with(empty_Array, empty_Array, PThreadedCode19077, 1, PSend19078);
    // ifFalse:. 
    Send PSend19075 = new_Send((Optr)PSend19074, SMB_ifFalse_, 1, (Optr)PBlock19076);
    // escape:. 
    Send PSend19081 = new_Send((Optr)VAR__return__1_0, SMB_escape_, 1, (Optr)true_Const);
    Array PThreadedCode19080 = instantiate_Array_with(ThreadedCode_Class, 0, 6, (Optr)&t_push_variable, (Optr)VAR__return__1_0, (Optr)&t_push_true, (Optr)&t_send1, (Optr)PSend19081, (Optr)&t_block_return);
    Block PBlock19079 = new_Block_with(empty_Array, empty_Array, PThreadedCode19080, 1, PSend19081);
    Symbol SMB_ifNil_ = new_Symbol(L"ifNil:");
    // ifNil:. 
    Send PSend19082 = new_Send((Optr)slot_PEG_Parser_semantics, SMB_ifNil_, 1, (Optr)PBlock19079);
    Symbol SMB_stack = new_Symbol(L"stack");
    // stack. 
    Send PSend19083 = new_Send((Optr)VAR_input_0_0, SMB_stack, 0);
    // stack. 
    Send PSend19084 = new_Send((Optr)VAR_input_0_0, SMB_stack, 0);
    Symbol SMB_peek = new_Symbol(L"peek");
    // peek. 
    Send PSend19085 = new_Send((Optr)PSend19084, SMB_peek, 0);
    Symbol SMB_value_ = new_Symbol(L"value:");
    // value:. 
    Send PSend19086 = new_Send((Optr)slot_PEG_Parser_semantics, SMB_value_, 1, (Optr)PSend19085);
    Symbol SMB_poke_ = new_Symbol(L"poke:");
    // poke:. 
    Send PSend19087 = new_Send((Optr)PSend19083, SMB_poke_, 1, (Optr)PSend19086);
    Array PThreadedCode19073 = instantiate_Array_with(ThreadedCode_Class, 0, 35, (Optr)&t_push_slot, (Optr)slot_PEG_Parser_expression, (Optr)&t_push_variable, (Optr)VAR_input_0_0, (Optr)&t_send1, (Optr)PSend19074, (Optr)&t_send_ifFalse_, (Optr)PSend19075, (Optr)PBlock19076, (Optr)&t_zap, (Optr)&t_push_slot, (Optr)slot_PEG_Parser_semantics, (Optr)&t_push_closure, (Optr)PBlock19079, (Optr)&t_send1, (Optr)PSend19082, (Optr)&t_zap, (Optr)&t_push_variable, (Optr)VAR_input_0_0, (Optr)&t_send0, (Optr)PSend19083, (Optr)&t_push_slot, (Optr)slot_PEG_Parser_semantics, (Optr)&t_push_variable, (Optr)VAR_input_0_0, (Optr)&t_send0, (Optr)PSend19084, (Optr)&t_send0, (Optr)PSend19085, (Optr)&t_send1, (Optr)PSend19086, (Optr)&t_send1, (Optr)PSend19087, (Optr)&t_zap, (Optr)&t_method_return_true);
    Block PBlock19071 = new_Block_with(PArray19072, empty_Array, PThreadedCode19073, 4, PSend19075, PSend19082, PSend19087, true_Const);
    Symbol SMB_on_ = new_Symbol(L"on:");
    // on:. 
    Send PSend19088 = new_Send((Optr)PContinue_classReference, SMB_on_, 1, (Optr)PBlock19071);
    Array PThreadedCode19070 = instantiate_Array_with(ThreadedCode_Class, 0, 7, (Optr)&t_push_class_reference, (Optr)PContinue_classReference, (Optr)&t_push_closure, (Optr)PBlock19071, (Optr)&t_send1, (Optr)PSend19088, (Optr)&t_method_return);
    Method PMethod19068 = new_Method_with(PArray19069, empty_Array, empty_Array, PThreadedCode19070, 1, PSend19088);
    
    MethodClosure MC_SMB_parseOn_ = new_MethodClosure((Method)PMethod19068, PEG_Parser_Class);
=======
...
<<<<<<< HEAD
    Array PArray19090 = new_Array_with(1, (Optr)VAR_aName_0_0);
    Assign PAssign19092 = new_Assign((Optr)slot_PEG_Parser_name, (Optr)VAR_aName_0_0);
    Array PThreadedCode19091 = instantiate_Array_with(ThreadedCode_Class, 0, 7, (Optr)&t_push1, (Optr)PAssign19092, (Optr)&t_push_variable, (Optr)VAR_aName_0_0, (Optr)&t_assign, (Optr)&t_zap, (Optr)&t_method_return_self);
    Method PMethod19089 = new_Method_with(PArray19090, empty_Array, empty_Array, PThreadedCode19091, 2, PAssign19092, self);
    
    MethodClosure MC_SMB_name_ = new_MethodClosure((Method)PMethod19089, PEG_Parser_Class);
=======
...
static void init_SMB_omitMatch_() {
    ...
    Variable VAR_input_0_0 = new_Variable_named(L"input", 0);
<<<<<<< HEAD
    Array PArray19094 = new_Array_with(1, (Optr)VAR_input_0_0);
    // omitMatch:. 
    Send PSend19096 = new_Send((Optr)slot_PEG_Parser_expression, SMB_omitMatch_, 1, (Optr)VAR_input_0_0);
    Array PThreadedCode19095 = instantiate_Array_with(ThreadedCode_Class, 0, 7, (Optr)&t_push_slot, (Optr)slot_PEG_Parser_expression, (Optr)&t_push_variable, (Optr)VAR_input_0_0, (Optr)&t_send1, (Optr)PSend19096, (Optr)&t_method_return);
    Method PMethod19093 = new_Method_with(PArray19094, empty_Array, empty_Array, PThreadedCode19095, 1, PSend19096);
    
    MethodClosure MC_SMB_omitMatch_ = new_MethodClosure((Method)PMethod19093, PEG_Parser_Class);
=======
...
<<<<<<< HEAD
    Array PArray19098 = new_Array_with(1, (Optr)VAR_aBlock_0_0);
    Assign PAssign19100 = new_Assign((Optr)slot_PEG_Parser_semantics, (Optr)VAR_aBlock_0_0);
    Array PThreadedCode19099 = instantiate_Array_with(ThreadedCode_Class, 0, 7, (Optr)&t_push1, (Optr)PAssign19100, (Optr)&t_push_variable, (Optr)VAR_aBlock_0_0, (Optr)&t_assign, (Optr)&t_zap, (Optr)&t_method_return_self);
    Method PMethod19097 = new_Method_with(PArray19098, empty_Array, empty_Array, PThreadedCode19099, 2, PAssign19100, self);
    
    MethodClosure MC_SMB_semantics_ = new_MethodClosure((Method)PMethod19097, PEG_Parser_Class);
=======
...
<<<<<<< HEAD
    Array PArray19102 = new_Array_with(1, (Optr)VAR_theExpression_0_0);
    Symbol SMB_asChildParser = new_Symbol(L"asChildParser");
    // asChildParser. 
    Send PSend19105 = new_Send((Optr)VAR_theExpression_0_0, SMB_asChildParser, 0);
    Assign PAssign19104 = new_Assign((Optr)slot_PEG_Parser_expression, (Optr)PSend19105);
    Array PThreadedCode19103 = instantiate_Array_with(ThreadedCode_Class, 0, 9, (Optr)&t_push1, (Optr)PAssign19104, (Optr)&t_push_variable, (Optr)VAR_theExpression_0_0, (Optr)&t_send0, (Optr)PSend19105, (Optr)&t_assign, (Optr)&t_zap, (Optr)&t_method_return_self);
    Method PMethod19101 = new_Method_with(PArray19102, empty_Array, empty_Array, PThreadedCode19103, 2, PAssign19104, self);
    
    MethodClosure MC_SMB__lt__equals_ = new_MethodClosure((Method)PMethod19101, PEG_Parser_Class);
=======
...
static void init_class_SMB_separators() {
    ...
    // basicSeparators. 
<<<<<<< HEAD
    Send PSend19108 = new_Send((Optr)PEGParser_classReference, SMB_basicSeparators, 0);
    Array PThreadedCode19107 = instantiate_Array_with(ThreadedCode_Class, 0, 5, (Optr)&t_push_class_reference, (Optr)PEGParser_classReference, (Optr)&t_send0, (Optr)PSend19108, (Optr)&t_method_return);
    Method PMethod19106 = new_Method_with(empty_Array, empty_Array, empty_Array, PThreadedCode19107, 1, PSend19108);
    
    MethodClosure MC_SMB_separators = new_MethodClosure((Method)PMethod19106, HEADER(PEG_Parser_Class));
=======
...
static void init_class_SMB_separator() {
    ...
    // basicSeparator. 
<<<<<<< HEAD
    Send PSend19111 = new_Send((Optr)PEGParser_classReference, SMB_basicSeparator, 0);
    Array PThreadedCode19110 = instantiate_Array_with(ThreadedCode_Class, 0, 5, (Optr)&t_push_class_reference, (Optr)PEGParser_classReference, (Optr)&t_send0, (Optr)PSend19111, (Optr)&t_method_return);
    Method PMethod19109 = new_Method_with(empty_Array, empty_Array, empty_Array, PThreadedCode19110, 1, PSend19111);
    
    MethodClosure MC_SMB_separator = new_MethodClosure((Method)PMethod19109, HEADER(PEG_Parser_Class));
=======
...
<<<<<<< HEAD
    Array PArray19120 = new_Array_with(1, (Optr)VAR__receiver__1_0);
    Symbol SMB_space = new_Symbol(L"space");
    // space. 
    Send PSend19122 = new_Send((Optr)Character_classReference, SMB_space, 0);
=======
...
>>>>>>> 0409bfcc3f9379d8b19cce9b02e2a910a0ce2629
    ...
    // at:put:. 
<<<<<<< HEAD
    Send PSend19123 = new_Send((Optr)VAR__receiver__1_0, SMB_at_put_, 2, (Optr)int_1_Const, (Optr)PSend19122);
    Symbol SMB_cr = new_Symbol(L"cr");
    // cr. 
    Send PSend19124 = new_Send((Optr)Character_classReference, SMB_cr, 0);
    SmallInt int_2 = new_SmallInt(2);
    Constant int_2_Const = new_Constant((Optr)int_2);
    // at:put:. 
    Send PSend19125 = new_Send((Optr)VAR__receiver__1_0, SMB_at_put_, 2, (Optr)int_2_Const, (Optr)PSend19124);
    SmallInt int_3 = new_SmallInt(3);
    Symbol SMB_lf = new_Symbol(L"lf");
    // lf. 
    Send PSend19126 = new_Send((Optr)Character_classReference, SMB_lf, 0);
    Constant int_3_Const = new_Constant((Optr)int_3);
    // at:put:. 
    Send PSend19127 = new_Send((Optr)VAR__receiver__1_0, SMB_at_put_, 2, (Optr)int_3_Const, (Optr)PSend19126);
    SmallInt int_4 = new_SmallInt(4);
    Symbol SMB_tab = new_Symbol(L"tab");
    // tab. 
    Send PSend19128 = new_Send((Optr)Character_classReference, SMB_tab, 0);
    Constant int_4_Const = new_Constant((Optr)int_4);
    // at:put:. 
    Send PSend19129 = new_Send((Optr)VAR__receiver__1_0, SMB_at_put_, 2, (Optr)int_4_Const, (Optr)PSend19128);
    Symbol SMB_yourself = new_Symbol(L"yourself");
    // yourself. 
    Send PSend19130 = new_Send((Optr)VAR__receiver__1_0, SMB_yourself, 0);
    Array PThreadedCode19121 = instantiate_Array_with(ThreadedCode_Class, 0, 47, (Optr)&t_push_variable, (Optr)VAR__receiver__1_0, (Optr)&t_push_1, (Optr)&t_push_class_reference, (Optr)Character_classReference, (Optr)&t_send0, (Optr)PSend19122, (Optr)&t_send2, (Optr)PSend19123, (Optr)&t_zap, (Optr)&t_push_variable, (Optr)VAR__receiver__1_0, (Optr)&t_push_2, (Optr)&t_push_class_reference, (Optr)Character_classReference, (Optr)&t_send0, (Optr)PSend19124, (Optr)&t_send2, (Optr)PSend19125, (Optr)&t_zap, (Optr)&t_push_variable, (Optr)VAR__receiver__1_0, (Optr)&t_push1, (Optr)int_3, (Optr)&t_push_class_reference, (Optr)Character_classReference, (Optr)&t_send0, (Optr)PSend19126, (Optr)&t_send2, (Optr)PSend19127, (Optr)&t_zap, (Optr)&t_push_variable, (Optr)VAR__receiver__1_0, (Optr)&t_push1, (Optr)int_4, (Optr)&t_push_class_reference, (Optr)Character_classReference, (Optr)&t_send0, (Optr)PSend19128, (Optr)&t_send2, (Optr)PSend19129, (Optr)&t_zap, (Optr)&t_push_variable, (Optr)VAR__receiver__1_0, (Optr)&t_send0, (Optr)PSend19130, (Optr)&t_method_return);
    Block PBlock19119 = new_Block_with(PArray19120, empty_Array, PThreadedCode19121, 5, PSend19123, PSend19125, PSend19127, PSend19129, PSend19130);
    Symbol SMB_value_ = new_Symbol(L"value:");
    Symbol SMB_new_ = new_Symbol(L"new:");
    // new:. 
    Send PSend19131 = new_Send((Optr)String_classReference, SMB_new_, 1, (Optr)int_4_Const);
    // value:. 
    Send PSend19118 = new_Send((Optr)PBlock19119, SMB_value_, 1, (Optr)PSend19131);
    Symbol SMB_asPEGChoice = new_Symbol(L"asPEGChoice");
    // asPEGChoice. 
    Send PSend19117 = new_Send((Optr)PSend19118, SMB_asPEGChoice, 0);
    Assign PAssign19116 = new_Assign((Optr)slot_PEG_Parser_Class_class_separators, (Optr)PSend19117);
    Array PThreadedCode19115 = instantiate_Array_with(ThreadedCode_Class, 0, 16, (Optr)&t_push1, (Optr)PAssign19116, (Optr)&t_push_closure, (Optr)PBlock19119, (Optr)&t_push_class_reference, (Optr)String_classReference, (Optr)&t_push1, (Optr)int_4, (Optr)&t_send1, (Optr)PSend19131, (Optr)&t_send1, (Optr)PSend19118, (Optr)&t_send0, (Optr)PSend19117, (Optr)&t_assign, (Optr)&t_block_return);
    Block PBlock19114 = new_Block_with(empty_Array, empty_Array, PThreadedCode19115, 1, PAssign19116);
    Symbol SMB_ifNil_ = new_Symbol(L"ifNil:");
    // ifNil:. 
    Send PSend19132 = new_Send((Optr)slot_PEG_Parser_Class_class_separators, SMB_ifNil_, 1, (Optr)PBlock19114);
    Array PThreadedCode19113 = instantiate_Array_with(ThreadedCode_Class, 0, 7, (Optr)&t_push_slot, (Optr)slot_PEG_Parser_Class_class_separators, (Optr)&t_push_closure, (Optr)PBlock19114, (Optr)&t_send1, (Optr)PSend19132, (Optr)&t_method_return);
    Method PMethod19112 = new_Method_with(empty_Array, empty_Array, empty_Array, PThreadedCode19113, 1, PSend19132);
    
    MethodClosure MC_SMB_basicSeparators = new_MethodClosure((Method)PMethod19112, HEADER(PEG_Parser_Class));
=======
...
<<<<<<< HEAD
    Array PArray19134 = new_Array_with(1, (Optr)VAR_theName_0_0);
    Symbol SMB_new = new_Symbol(L"new");
    // new. 
    Send PSend19136 = new_Send((Optr)self, SMB_new, 0);
    Symbol SMB_name_ = new_Symbol(L"name:");
    // name:. 
    Send PSend19137 = new_Send((Optr)PSend19136, SMB_name_, 1, (Optr)VAR_theName_0_0);
    Array PThreadedCode19135 = instantiate_Array_with(ThreadedCode_Class, 0, 8, (Optr)&t_push_self, (Optr)&t_send0, (Optr)PSend19136, (Optr)&t_push_variable, (Optr)VAR_theName_0_0, (Optr)&t_send1, (Optr)PSend19137, (Optr)&t_method_return);
    Method PMethod19133 = new_Method_with(PArray19134, empty_Array, empty_Array, PThreadedCode19135, 1, PSend19137);
    
    MethodClosure MC_SMB_named_ = new_MethodClosure((Method)PMethod19133, HEADER(PEG_Parser_Class));
=======
...
<<<<<<< HEAD
    Array PArray19139 = new_Array_with(2, (Optr)VAR_theName_0_0, (Optr)VAR_expression_0_1);
    Symbol SMB_named_ = new_Symbol(L"named:");
    // named:. 
    Send PSend19141 = new_Send((Optr)self, SMB_named_, 1, (Optr)VAR_theName_0_0);
    Symbol SMB__lt__equals_ = new_Symbol(L"<=");
    // <=. 
    Send PSend19142 = new_Send((Optr)PSend19141, SMB__lt__equals_, 1, (Optr)VAR_expression_0_1);
    Array PThreadedCode19140 = instantiate_Array_with(ThreadedCode_Class, 0, 10, (Optr)&t_push_self, (Optr)&t_push_variable, (Optr)VAR_theName_0_0, (Optr)&t_send1, (Optr)PSend19141, (Optr)&t_push_variable, (Optr)VAR_expression_0_1, (Optr)&t_send1, (Optr)PSend19142, (Optr)&t_method_return);
    Method PMethod19138 = new_Method_with(PArray19139, empty_Array, empty_Array, PThreadedCode19140, 1, PSend19142);
    
    MethodClosure MC_SMB_named_parsing_ = new_MethodClosure((Method)PMethod19138, HEADER(PEG_Parser_Class));
=======
...
<<<<<<< HEAD
    Assign PAssign19145 = new_Assign((Optr)slot_PEG_Parser_Class_class_separator, (Optr)nil_Const);
    Assign PAssign19146 = new_Assign((Optr)slot_PEG_Parser_Class_class_separators, (Optr)nil_Const);
    Array PThreadedCode19144 = instantiate_Array_with(ThreadedCode_Class, 0, 11, (Optr)&t_push1, (Optr)PAssign19145, (Optr)&t_push_nil, (Optr)&t_assign, (Optr)&t_zap, (Optr)&t_push1, (Optr)PAssign19146, (Optr)&t_push_nil, (Optr)&t_assign, (Optr)&t_zap, (Optr)&t_method_return_self);
    Method PMethod19143 = new_Method_with(empty_Array, empty_Array, empty_Array, PThreadedCode19144, 3, PAssign19145, PAssign19146, self);
    
    MethodClosure MC_SMB_reset = new_MethodClosure((Method)PMethod19143, HEADER(PEG_Parser_Class));
=======
...
static void init_class_SMB_basicSeparator() {
    ...
    // basicSeparators. 
<<<<<<< HEAD
    Send PSend19154 = new_Send((Optr)self, SMB_basicSeparators, 0);
    Symbol SMB_strongTimes = new_Symbol(L"strongTimes");
    // strongTimes. 
    Send PSend19153 = new_Send((Optr)PSend19154, SMB_strongTimes, 0);
    Symbol SMB_omit = new_Symbol(L"omit");
    // omit. 
    Send PSend19152 = new_Send((Optr)PSend19153, SMB_omit, 0);
    Assign PAssign19151 = new_Assign((Optr)slot_PEG_Parser_Class_class_separator, (Optr)PSend19152);
    Array PThreadedCode19150 = instantiate_Array_with(ThreadedCode_Class, 0, 11, (Optr)&t_push1, (Optr)PAssign19151, (Optr)&t_push_self, (Optr)&t_send0, (Optr)PSend19154, (Optr)&t_send0, (Optr)PSend19153, (Optr)&t_send0, (Optr)PSend19152, (Optr)&t_assign, (Optr)&t_block_return);
    Block PBlock19149 = new_Block_with(empty_Array, empty_Array, PThreadedCode19150, 1, PAssign19151);
    Symbol SMB_ifNil_ = new_Symbol(L"ifNil:");
    // ifNil:. 
    Send PSend19155 = new_Send((Optr)slot_PEG_Parser_Class_class_separator, SMB_ifNil_, 1, (Optr)PBlock19149);
    Array PThreadedCode19148 = instantiate_Array_with(ThreadedCode_Class, 0, 7, (Optr)&t_push_slot, (Optr)slot_PEG_Parser_Class_class_separator, (Optr)&t_push_closure, (Optr)PBlock19149, (Optr)&t_send1, (Optr)PSend19155, (Optr)&t_method_return);
    Method PMethod19147 = new_Method_with(empty_Array, empty_Array, empty_Array, PThreadedCode19148, 1, PSend19155);
    
    MethodClosure MC_SMB_basicSeparator = new_MethodClosure((Method)PMethod19147, HEADER(PEG_Parser_Class));
=======
...
<<<<<<< HEAD
    Array PArray19157 = new_Array_with(3, (Optr)VAR_theName_0_0, (Optr)VAR_expression_0_1, (Optr)VAR_semantics_0_2);
    Symbol SMB_named_parsing_ = new_Symbol(L"named:parsing:");
    // named:parsing:. 
    Send PSend19159 = new_Send((Optr)self, SMB_named_parsing_, 2, (Optr)VAR_theName_0_0, (Optr)VAR_expression_0_1);
    Symbol SMB_semantics_ = new_Symbol(L"semantics:");
    // semantics:. 
    Send PSend19160 = new_Send((Optr)PSend19159, SMB_semantics_, 1, (Optr)VAR_semantics_0_2);
    Array PThreadedCode19158 = instantiate_Array_with(ThreadedCode_Class, 0, 12, (Optr)&t_push_self, (Optr)&t_push_variable, (Optr)VAR_theName_0_0, (Optr)&t_push_variable, (Optr)VAR_expression_0_1, (Optr)&t_send2, (Optr)PSend19159, (Optr)&t_push_variable, (Optr)VAR_semantics_0_2, (Optr)&t_send1, (Optr)PSend19160, (Optr)&t_method_return);
    Method PMethod19156 = new_Method_with(PArray19157, empty_Array, empty_Array, PThreadedCode19158, 1, PSend19160);
    
    MethodClosure MC_SMB_named_parsing_semantics_ = new_MethodClosure((Method)PMethod19156, HEADER(PEG_Parser_Class));
=======
