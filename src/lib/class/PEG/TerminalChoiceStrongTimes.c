...
static void init_SMB_parseOn_() {
    ...
    Array PArray19716 = new_Array_with(1, (Optr)VAR_input_0_0);
    Symbol SMB_pushAllIn_ = new_Symbol(L"pushAllIn:");
    // pushAllIn:. 
    Send PSend19718 = new_Send((Optr)VAR_input_0_0, SMB_pushAllIn_, 1, (Optr)slot_PEG_Terminal_terminal);
    Array PThreadedCode19717 = instantiate_Array_with(ThreadedCode_Class, 0, 8, (Optr)&t_push_variable, (Optr)VAR_input_0_0, (Optr)&t_push_slot, (Optr)slot_PEG_Terminal_terminal, (Optr)&t_send1, (Optr)PSend19718, (Optr)&t_zap, (Optr)&t_method_return_true);
    Method PMethod19715 = new_Method_with(PArray19716, empty_Array, empty_Array, PThreadedCode19717, 2, PSend19718, true_Const);
    
    MethodClosure MC_SMB_parseOn_ = new_MethodClosure((Method)PMethod19715, PEG_TerminalChoiceStrongTimes_Class);
...
static void init_SMB_omitMatch_() {
    ...
    Variable VAR_input_0_0 = new_Variable_named(L"input", 0);
    Array PArray19720 = new_Array_with(1, (Optr)VAR_input_0_0);
    Symbol SMB_scanAllIn_ = new_Symbol(L"scanAllIn:");
    // scanAllIn:. 
    Send PSend19722 = new_Send((Optr)VAR_input_0_0, SMB_scanAllIn_, 1, (Optr)slot_PEG_Terminal_terminal);
    Array PThreadedCode19721 = instantiate_Array_with(ThreadedCode_Class, 0, 8, (Optr)&t_push_variable, (Optr)VAR_input_0_0, (Optr)&t_push_slot, (Optr)slot_PEG_Terminal_terminal, (Optr)&t_send1, (Optr)PSend19722, (Optr)&t_zap, (Optr)&t_method_return_true);
    Method PMethod19719 = new_Method_with(PArray19720, empty_Array, empty_Array, PThreadedCode19721, 2, PSend19722, true_Const);
    
    MethodClosure MC_SMB_omitMatch_ = new_MethodClosure((Method)PMethod19719, PEG_TerminalChoiceStrongTimes_Class);
