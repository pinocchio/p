...
static void init_SMB_resultIfFailed_() {
    ...
    Array PArray20335 = new_Array_with(1, (Optr)VAR_alternative_0_0);
    Symbol SMB_subclassResponsibility = new_Symbol(L"subclassResponsibility");
    // subclassResponsibility. 
    Send PSend20337 = new_Send((Optr)self, SMB_subclassResponsibility, 0);
    Array PThreadedCode20336 = instantiate_Array_with(ThreadedCode_Class, 0, 5, (Optr)&t_push_self, (Optr)&t_send0, (Optr)PSend20337, (Optr)&t_zap, (Optr)&t_method_return_self);
    Method PMethod20334 = new_Method_with(PArray20335, empty_Array, empty_Array, PThreadedCode20336, 2, PSend20337, self);
    
    MethodClosure MC_SMB_resultIfFailed_ = new_MethodClosure((Method)PMethod20334, PEG_OptionalResult_Class);
