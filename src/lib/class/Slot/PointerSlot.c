...
static void init_SMB_readFrom_() {
    ...
    Array PArray21951 = new_Array_with(1, (Optr)VAR_anObject_0_0);
    Symbol SMB_shouldNotCall = new_Symbol(L"shouldNotCall");
    // shouldNotCall. 
    Send PSend21953 = new_Send((Optr)self, SMB_shouldNotCall, 0);
    Array PThreadedCode21952 = instantiate_Array_with(ThreadedCode_Class, 0, 5, (Optr)&t_push_self, (Optr)&t_send0, (Optr)PSend21953, (Optr)&t_zap, (Optr)&t_method_return_self);
    Method PMethod21950 = new_Method_with(PArray21951, empty_Array, empty_Array, PThreadedCode21952, 2, PSend21953, self);
    
    MethodClosure MC_SMB_readFrom_ = new_MethodClosure((Method)PMethod21950, PointerSlot_Class);
...
static void init_SMB_assign_on_() {
    ...
    Array PArray21955 = new_Array_with(2, (Optr)VAR_value_0_0, (Optr)VAR_anObject_0_1);
    Symbol SMB_shouldNotCall = new_Symbol(L"shouldNotCall");
    // shouldNotCall. 
    Send PSend21957 = new_Send((Optr)self, SMB_shouldNotCall, 0);
    Array PThreadedCode21956 = instantiate_Array_with(ThreadedCode_Class, 0, 5, (Optr)&t_push_self, (Optr)&t_send0, (Optr)PSend21957, (Optr)&t_zap, (Optr)&t_method_return_self);
    Method PMethod21954 = new_Method_with(PArray21955, empty_Array, empty_Array, PThreadedCode21956, 2, PSend21957, self);
    
    MethodClosure MC_SMB_assign_on_ = new_MethodClosure((Method)PMethod21954, PointerSlot_Class);
...
static void init_SMB_accept_() {
    ...
    Array PArray21959 = new_Array_with(1, (Optr)VAR_visitor_0_0);
    Symbol SMB_visitPointerSlot_ = new_Symbol(L"visitPointerSlot:");
    // visitPointerSlot:. 
    Send PSend21961 = new_Send((Optr)VAR_visitor_0_0, SMB_visitPointerSlot_, 1, (Optr)self);
    Array PThreadedCode21960 = instantiate_Array_with(ThreadedCode_Class, 0, 6, (Optr)&t_push_variable, (Optr)VAR_visitor_0_0, (Optr)&t_push_self, (Optr)&t_send1, (Optr)PSend21961, (Optr)&t_method_return);
    Method PMethod21958 = new_Method_with(PArray21959, empty_Array, empty_Array, PThreadedCode21960, 1, PSend21961);
    
    MethodClosure MC_SMB_accept_ = new_MethodClosure((Method)PMethod21958, PointerSlot_Class);
...
static void init_SMB_assignFor_to_() {
    ...
    Array PArray21963 = new_Array_with(2, (Optr)VAR_visitor_0_0, (Optr)VAR_value_0_1);
    Symbol SMB_shouldNotCall = new_Symbol(L"shouldNotCall");
    // shouldNotCall. 
    Send PSend21965 = new_Send((Optr)self, SMB_shouldNotCall, 0);
    Array PThreadedCode21964 = instantiate_Array_with(ThreadedCode_Class, 0, 5, (Optr)&t_push_self, (Optr)&t_send0, (Optr)PSend21965, (Optr)&t_zap, (Optr)&t_method_return_self);
    Method PMethod21962 = new_Method_with(PArray21963, empty_Array, empty_Array, PThreadedCode21964, 2, PSend21965, self);
    
    MethodClosure MC_SMB_assignFor_to_ = new_MethodClosure((Method)PMethod21962, PointerSlot_Class);
