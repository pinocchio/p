...
static void init_SMB_printOn_() {
    ...
    // <<. 
    Send PSend5739 = new_Send((Optr)VAR_aStream_0_0, SMB__shiftLeft_, 1, (Optr)char_4799_Const);
    // printOn:. 
    ...
    // <<. 
    Send PSend5741 = new_Send((Optr)VAR_aStream_0_0, SMB__shiftLeft_, 1, (Optr)char_4146_Const);
    Array PThreadedCode5735 = instantiate_Array_with(ThreadedCode_Class, 0, 36, (Optr)&t_push_variable, (Optr)VAR_aStream_0_0, (Optr)&t_push1, (Optr)char_5736, (Optr)&t_send1, (Optr)PSend5737, (Optr)&t_zap, (Optr)&t_push_slot, (Optr)slot_Graphics_Primitives_Point_x, (Optr)&t_push_variable, (Optr)VAR_aStream_0_0, (Optr)&t_send1, (Optr)PSend5738, (Optr)&t_zap, (Optr)&t_push_variable, (Optr)VAR_aStream_0_0, (Optr)&t_push1, (Optr)char_4799, (Optr)&t_send1, (Optr)PSend5739, (Optr)&t_zap, (Optr)&t_push_slot, (Optr)slot_Graphics_Primitives_Point_y, (Optr)&t_push_variable, (Optr)VAR_aStream_0_0, (Optr)&t_send1, (Optr)PSend5740, (Optr)&t_zap, (Optr)&t_push_variable, (Optr)VAR_aStream_0_0, (Optr)&t_push1, (Optr)char_4146, (Optr)&t_send1, (Optr)PSend5741, (Optr)&t_zap, (Optr)&t_method_return_self);
