...
=======
    Array PThreadedCode8552 = instantiate_Array_with(ThreadedCode_Class, 0, 3, (Optr)&t_push_slot, (Optr)slot_Runtime_MethodClosure_selector, (Optr)&t_method_return);
    Method PMethod8551 = new_Method_with(empty_Array, empty_Array, empty_Array, PThreadedCode8552, 1, slot_Runtime_MethodClosure_selector);
    
    MethodClosure MC_SMB_selector = new_MethodClosure((Method)PMethod8551, MethodClosure_Class);
...
=======
    Array PArray8554 = new_Array_with(3, (Optr)VAR_visitor_0_0, (Optr)VAR_receiver_0_1, (Optr)VAR_message_0_2);
    Symbol SMB_accept_on_message_boundBy_ = new_Symbol(L"accept:on:message:boundBy:");
    // accept:on:message:boundBy:. 
    Send PSend8556 = new_Send((Optr)slot_Runtime_Closure_code, SMB_accept_on_message_boundBy_, 4, (Optr)VAR_visitor_0_0, (Optr)VAR_receiver_0_1, (Optr)VAR_message_0_2, (Optr)self);
    Array PThreadedCode8555 = instantiate_Array_with(ThreadedCode_Class, 0, 12, (Optr)&t_push_slot, (Optr)slot_Runtime_Closure_code, (Optr)&t_push_variable, (Optr)VAR_visitor_0_0, (Optr)&t_push_variable, (Optr)VAR_receiver_0_1, (Optr)&t_push_variable, (Optr)VAR_message_0_2, (Optr)&t_push_self, (Optr)&t_send4, (Optr)PSend8556, (Optr)&t_method_return);
    Method PMethod8553 = new_Method_with(PArray8554, empty_Array, empty_Array, PThreadedCode8555, 1, PSend8556);
    
    MethodClosure MC_SMB_accept_on_message_ = new_MethodClosure((Method)PMethod8553, MethodClosure_Class);
>>>>>>> 0409bfcc3f9379d8b19cce9b02e2a910a0ce2629
...
=======
    Array PArray8558 = new_Array_with(1, (Optr)VAR_aPinocchioClass_0_0);
    Assign PAssign8560 = new_Assign((Optr)slot_Runtime_MethodClosure_host, (Optr)VAR_aPinocchioClass_0_0);
    Array PThreadedCode8559 = instantiate_Array_with(ThreadedCode_Class, 0, 7, (Optr)&t_push1, (Optr)PAssign8560, (Optr)&t_push_variable, (Optr)VAR_aPinocchioClass_0_0, (Optr)&t_assign, (Optr)&t_zap, (Optr)&t_method_return_self);
    Method PMethod8557 = new_Method_with(PArray8558, empty_Array, empty_Array, PThreadedCode8559, 2, PAssign8560, self);
    
    MethodClosure MC_SMB_pclass_ = new_MethodClosure((Method)PMethod8557, MethodClosure_Class);
>>>>>>> 0409bfcc3f9379d8b19cce9b02e2a910a0ce2629
...
=======
    Array PArray8562 = new_Array_with(1, (Optr)VAR_anObject_0_0);
    Assign PAssign8564 = new_Assign((Optr)slot_Runtime_MethodClosure_selector, (Optr)VAR_anObject_0_0);
    Array PThreadedCode8563 = instantiate_Array_with(ThreadedCode_Class, 0, 7, (Optr)&t_push1, (Optr)PAssign8564, (Optr)&t_push_variable, (Optr)VAR_anObject_0_0, (Optr)&t_assign, (Optr)&t_zap, (Optr)&t_method_return_self);
    Method PMethod8561 = new_Method_with(PArray8562, empty_Array, empty_Array, PThreadedCode8563, 2, PAssign8564, self);
    
    MethodClosure MC_SMB_selector_ = new_MethodClosure((Method)PMethod8561, MethodClosure_Class);
>>>>>>> 0409bfcc3f9379d8b19cce9b02e2a910a0ce2629
...
=======
    Array PArray8566 = new_Array_with(1, (Optr)VAR_arguments_0_0);
    Symbol SMB_pPrimitive_plugin_ = new_Symbol(L"pPrimitive:plugin:");
    Symbol SMB_AST_minus_MethodClosure = new_Symbol(L"AST.MethodClosure");
    Annotation PAnnotation8568 = new_Annotation((Optr)SMB_pPrimitive_plugin_, 2, (Optr)SMB_valueWithArguments_, (Optr)SMB_AST_minus_MethodClosure);
    Array PArray8567 = new_Array_with(1, (Optr)PAnnotation8568);
    Symbol SMB_pinocchioPrimitiveFailed = new_Symbol(L"pinocchioPrimitiveFailed");
    // pinocchioPrimitiveFailed. 
    Send PSend8570 = new_Send((Optr)self, SMB_pinocchioPrimitiveFailed, 0);
    Array PThreadedCode8569 = instantiate_Array_with(ThreadedCode_Class, 0, 5, (Optr)&t_push_self, (Optr)&t_send0, (Optr)PSend8570, (Optr)&t_zap, (Optr)&t_method_return_self);
    NativeMethod PNativeMethod8565 = new_NativeMethod_with(PArray8566, empty_Array, PArray8567, PThreadedCode8569, 2, PSend8570, self);
    
    MethodClosure MC_SMB_valueWithArguments_ = new_MethodClosure((Method)PNativeMethod8565, MethodClosure_Class);
>>>>>>> 0409bfcc3f9379d8b19cce9b02e2a910a0ce2629
...
=======
    Array PArray8572 = new_Array_with(1, (Optr)VAR_anArray_0_0);
    Variable VAR_numArgs_0_1 = new_Variable_named(L"numArgs", 0);
    Array PArray8573 = new_Array_with(1, (Optr)VAR_numArgs_0_1);
    Variable VAR__return__1_0 = new_Variable_named(L"_return_", 1);
    Array PArray8576 = new_Array_with(1, (Optr)VAR__return__1_0);
    Symbol SMB_numArgs = new_Symbol(L"numArgs");
    // numArgs. 
    Send PSend8579 = new_Send((Optr)self, SMB_numArgs, 0);
    Assign PAssign8578 = new_Assign((Optr)VAR_numArgs_0_1, (Optr)PSend8579);
>>>>>>> 0409bfcc3f9379d8b19cce9b02e2a910a0ce2629
...
=======
    Send PSend8580 = new_Send((Optr)VAR_numArgs_0_1, SMB__equals_, 1, (Optr)int_0_Const);
    Symbol SMB_ifTrue_ = new_Symbol(L"ifTrue:");
    Symbol SMB_value = new_Symbol(L"value");
    // value. 
    Send PSend8584 = new_Send((Optr)self, SMB_value, 0);
    Symbol SMB_escape_ = new_Symbol(L"escape:");
    // escape:. 
    Send PSend8585 = new_Send((Optr)VAR__return__1_0, SMB_escape_, 1, (Optr)PSend8584);
    Array PThreadedCode8583 = instantiate_Array_with(ThreadedCode_Class, 0, 8, (Optr)&t_push_variable, (Optr)VAR__return__1_0, (Optr)&t_push_self, (Optr)&t_send0, (Optr)PSend8584, (Optr)&t_send1, (Optr)PSend8585, (Optr)&t_block_return);
    Block PBlock8582 = new_Block_with(empty_Array, empty_Array, PThreadedCode8583, 1, PSend8585);
    // ifTrue:. 
    Send PSend8581 = new_Send((Optr)PSend8580, SMB_ifTrue_, 1, (Optr)PBlock8582);
    Symbol SMB_size = new_Symbol(L"size");
    // size. 
    Send PSend8586 = new_Send((Optr)VAR_anArray_0_0, SMB_size, 0);
    // =. 
    Send PSend8587 = new_Send((Optr)VAR_numArgs_0_1, SMB__equals_, 1, (Optr)PSend8586);
    Symbol SMB_valueWithArguments_ = new_Symbol(L"valueWithArguments:");
    // valueWithArguments:. 
    Send PSend8591 = new_Send((Optr)self, SMB_valueWithArguments_, 1, (Optr)VAR_anArray_0_0);
    Array PThreadedCode8590 = instantiate_Array_with(ThreadedCode_Class, 0, 6, (Optr)&t_push_self, (Optr)&t_push_variable, (Optr)VAR_anArray_0_0, (Optr)&t_send1, (Optr)PSend8591, (Optr)&t_block_return);
    Block PBlock8589 = new_Block_with(empty_Array, empty_Array, PThreadedCode8590, 1, PSend8591);
    // ifTrue:. 
    Send PSend8588 = new_Send((Optr)PSend8587, SMB_ifTrue_, 1, (Optr)PBlock8589);
    // size. 
    Send PSend8592 = new_Send((Optr)VAR_anArray_0_0, SMB_size, 0);
    Symbol SMB__gt_ = new_Symbol(L">");
    // >. 
    Send PSend8593 = new_Send((Optr)VAR_numArgs_0_1, SMB__gt_, 1, (Optr)PSend8592);
    // size. 
    Send PSend8597 = new_Send((Optr)VAR_anArray_0_0, SMB_size, 0);
    Symbol SMB__minus_ = new_Symbol(L"-");
    // -. 
    Send PSend8598 = new_Send((Optr)VAR_numArgs_0_1, SMB__minus_, 1, (Optr)PSend8597);
    Symbol SMB_new_ = new_Symbol(L"new:");
    // new:. 
    Send PSend8599 = new_Send((Optr)Array_classReference, SMB_new_, 1, (Optr)PSend8598);
    Symbol SMB__append_ = new_Symbol(L",");
    // ,. 
    Send PSend8600 = new_Send((Optr)VAR_anArray_0_0, SMB__append_, 1, (Optr)PSend8599);
    // valueWithArguments:. 
    Send PSend8601 = new_Send((Optr)self, SMB_valueWithArguments_, 1, (Optr)PSend8600);
    Array PThreadedCode8596 = instantiate_Array_with(ThreadedCode_Class, 0, 20, (Optr)&t_push_self, (Optr)&t_push_variable, (Optr)VAR_anArray_0_0, (Optr)&t_push_class_reference, (Optr)Array_classReference, (Optr)&t_push_variable, (Optr)VAR_numArgs_0_1, (Optr)&t_push_variable, (Optr)VAR_anArray_0_0, (Optr)&t_send0, (Optr)PSend8597, (Optr)&t_send1, (Optr)PSend8598, (Optr)&t_send1, (Optr)PSend8599, (Optr)&t_send1, (Optr)PSend8600, (Optr)&t_send1, (Optr)PSend8601, (Optr)&t_block_return);
    Block PBlock8595 = new_Block_with(empty_Array, empty_Array, PThreadedCode8596, 1, PSend8601);
    // ifTrue:. 
    Send PSend8594 = new_Send((Optr)PSend8593, SMB_ifTrue_, 1, (Optr)PBlock8595);
>>>>>>> 0409bfcc3f9379d8b19cce9b02e2a910a0ce2629
...
=======
    Send PSend8602 = new_Send((Optr)VAR_anArray_0_0, SMB_copyFrom_to_, 2, (Optr)int_1_Const, (Optr)VAR_numArgs_0_1);
    // valueWithArguments:. 
    Send PSend8603 = new_Send((Optr)self, SMB_valueWithArguments_, 1, (Optr)PSend8602);
    Array PThreadedCode8577 = instantiate_Array_with(ThreadedCode_Class, 0, 51, (Optr)&t_push1, (Optr)PAssign8578, (Optr)&t_push_self, (Optr)&t_send0, (Optr)PSend8579, (Optr)&t_assign, (Optr)&t_zap, (Optr)&t_push_variable, (Optr)VAR_numArgs_0_1, (Optr)&t_push_0, (Optr)&t_send1, (Optr)PSend8580, (Optr)&t_send_ifTrue_, (Optr)PSend8581, (Optr)PBlock8582, (Optr)&t_zap, (Optr)&t_push_variable, (Optr)VAR_numArgs_0_1, (Optr)&t_push_variable, (Optr)VAR_anArray_0_0, (Optr)&t_send0, (Optr)PSend8586, (Optr)&t_send1, (Optr)PSend8587, (Optr)&t_send_ifTrue_, (Optr)PSend8588, (Optr)PBlock8589, (Optr)&t_zap, (Optr)&t_push_variable, (Optr)VAR_numArgs_0_1, (Optr)&t_push_variable, (Optr)VAR_anArray_0_0, (Optr)&t_send0, (Optr)PSend8592, (Optr)&t_send1, (Optr)PSend8593, (Optr)&t_send_ifTrue_, (Optr)PSend8594, (Optr)PBlock8595, (Optr)&t_zap, (Optr)&t_push_self, (Optr)&t_push_variable, (Optr)VAR_anArray_0_0, (Optr)&t_push_1, (Optr)&t_push_variable, (Optr)VAR_numArgs_0_1, (Optr)&t_send2, (Optr)PSend8602, (Optr)&t_send1, (Optr)PSend8603, (Optr)&t_method_return);
    Block PBlock8575 = new_Block_with(PArray8576, empty_Array, PThreadedCode8577, 5, PAssign8578, PSend8581, PSend8588, PSend8594, PSend8603);
    Symbol SMB_on_ = new_Symbol(L"on:");
    // on:. 
    Send PSend8604 = new_Send((Optr)PContinue_classReference, SMB_on_, 1, (Optr)PBlock8575);
    Array PThreadedCode8574 = instantiate_Array_with(ThreadedCode_Class, 0, 7, (Optr)&t_push_class_reference, (Optr)PContinue_classReference, (Optr)&t_push_closure, (Optr)PBlock8575, (Optr)&t_send1, (Optr)PSend8604, (Optr)&t_method_return);
    Method PMethod8571 = new_Method_with(PArray8572, PArray8573, empty_Array, PThreadedCode8574, 1, PSend8604);
    
    MethodClosure MC_SMB_valueWithPossibleArgs_ = new_MethodClosure((Method)PMethod8571, MethodClosure_Class);
>>>>>>> 0409bfcc3f9379d8b19cce9b02e2a910a0ce2629
...
=======
    Array PArray8606 = new_Array_with(1, (Optr)VAR_visitor_0_0);
    Symbol SMB_visitMethodClosure_ = new_Symbol(L"visitMethodClosure:");
    // visitMethodClosure:. 
    Send PSend8608 = new_Send((Optr)VAR_visitor_0_0, SMB_visitMethodClosure_, 1, (Optr)self);
    Array PThreadedCode8607 = instantiate_Array_with(ThreadedCode_Class, 0, 6, (Optr)&t_push_variable, (Optr)VAR_visitor_0_0, (Optr)&t_push_self, (Optr)&t_send1, (Optr)PSend8608, (Optr)&t_method_return);
    Method PMethod8605 = new_Method_with(PArray8606, empty_Array, empty_Array, PThreadedCode8607, 1, PSend8608);
    
    MethodClosure MC_SMB_accept_ = new_MethodClosure((Method)PMethod8605, MethodClosure_Class);
>>>>>>> 0409bfcc3f9379d8b19cce9b02e2a910a0ce2629
...
=======
    Send PSend8611 = new_Send((Optr)slot_Runtime_Closure_code, SMB_annotations, 0);
    Array PThreadedCode8610 = instantiate_Array_with(ThreadedCode_Class, 0, 5, (Optr)&t_push_slot, (Optr)slot_Runtime_Closure_code, (Optr)&t_send0, (Optr)PSend8611, (Optr)&t_method_return);
    Method PMethod8609 = new_Method_with(empty_Array, empty_Array, empty_Array, PThreadedCode8610, 1, PSend8611);
    
    MethodClosure MC_SMB_annotations = new_MethodClosure((Method)PMethod8609, MethodClosure_Class);
>>>>>>> 0409bfcc3f9379d8b19cce9b02e2a910a0ce2629
...
=======
    Send PSend8614 = new_Send((Optr)slot_Runtime_Closure_code, SMB_numArgs, 0);
    Array PThreadedCode8613 = instantiate_Array_with(ThreadedCode_Class, 0, 5, (Optr)&t_push_slot, (Optr)slot_Runtime_Closure_code, (Optr)&t_send0, (Optr)PSend8614, (Optr)&t_method_return);
    Method PMethod8612 = new_Method_with(empty_Array, empty_Array, empty_Array, PThreadedCode8613, 1, PSend8614);
    
    MethodClosure MC_SMB_numArgs = new_MethodClosure((Method)PMethod8612, MethodClosure_Class);
>>>>>>> 0409bfcc3f9379d8b19cce9b02e2a910a0ce2629
...
=======
    Array PArray8616 = new_Array_with(1, (Optr)VAR_selector_0_0);
    // annotationAt:. 
    Send PSend8618 = new_Send((Optr)slot_Runtime_Closure_code, SMB_annotationAt_, 1, (Optr)VAR_selector_0_0);
    Array PThreadedCode8617 = instantiate_Array_with(ThreadedCode_Class, 0, 7, (Optr)&t_push_slot, (Optr)slot_Runtime_Closure_code, (Optr)&t_push_variable, (Optr)VAR_selector_0_0, (Optr)&t_send1, (Optr)PSend8618, (Optr)&t_method_return);
    Method PMethod8615 = new_Method_with(PArray8616, empty_Array, empty_Array, PThreadedCode8617, 1, PSend8618);
    
    MethodClosure MC_SMB_annotationAt_ = new_MethodClosure((Method)PMethod8615, MethodClosure_Class);
>>>>>>> 0409bfcc3f9379d8b19cce9b02e2a910a0ce2629
...
=======
    Array PThreadedCode8620 = instantiate_Array_with(ThreadedCode_Class, 0, 3, (Optr)&t_push_slot, (Optr)slot_Runtime_MethodClosure_host, (Optr)&t_method_return);
    Method PMethod8619 = new_Method_with(empty_Array, empty_Array, empty_Array, PThreadedCode8620, 1, slot_Runtime_MethodClosure_host);
    
    MethodClosure MC_SMB_pclass = new_MethodClosure((Method)PMethod8619, MethodClosure_Class);
>>>>>>> 0409bfcc3f9379d8b19cce9b02e2a910a0ce2629
...
=======
    Array PArray8622 = new_Array_with(1, (Optr)VAR_aClass_0_0);
    Assign PAssign8624 = new_Assign((Optr)slot_Runtime_MethodClosure_host, (Optr)VAR_aClass_0_0);
    Array PThreadedCode8623 = instantiate_Array_with(ThreadedCode_Class, 0, 7, (Optr)&t_push1, (Optr)PAssign8624, (Optr)&t_push_variable, (Optr)VAR_aClass_0_0, (Optr)&t_assign, (Optr)&t_zap, (Optr)&t_method_return_self);
    Method PMethod8621 = new_Method_with(PArray8622, empty_Array, empty_Array, PThreadedCode8623, 2, PAssign8624, self);
    
    MethodClosure MC_SMB_host_ = new_MethodClosure((Method)PMethod8621, MethodClosure_Class);
>>>>>>> 0409bfcc3f9379d8b19cce9b02e2a910a0ce2629
...
=======
    Array PThreadedCode8626 = instantiate_Array_with(ThreadedCode_Class, 0, 3, (Optr)&t_push_slot, (Optr)slot_Runtime_MethodClosure_host, (Optr)&t_method_return);
    Method PMethod8625 = new_Method_with(empty_Array, empty_Array, empty_Array, PThreadedCode8626, 1, slot_Runtime_MethodClosure_host);
    
    MethodClosure MC_SMB_host = new_MethodClosure((Method)PMethod8625, MethodClosure_Class);
>>>>>>> 0409bfcc3f9379d8b19cce9b02e2a910a0ce2629
