...
static void init_SMB_inspectChildrenOn_() {
    ...
    Array PArray4695 = new_Array_with(1, (Optr)VAR_inspector_0_0);
    Symbol SMB_class = new_Symbol(L"class");
    // class. 
    Send PSend4697 = new_Send((Optr)self, SMB_class, 0);
    Symbol SMB_superclass = new_Symbol(L"superclass");
    // superclass. 
    Send PSend4698 = new_Send((Optr)PSend4697, SMB_superclass, 0);
    Symbol SMB_layout = new_Symbol(L"layout");
    // layout. 
    Send PSend4699 = new_Send((Optr)PSend4698, SMB_layout, 0);
    Symbol SMB_inspectChildrenFrom_on_ = new_Symbol(L"inspectChildrenFrom:on:");
    // inspectChildrenFrom:on:. 
    Send PSend4700 = new_Send((Optr)PSend4699, SMB_inspectChildrenFrom_on_, 2, (Optr)self, (Optr)VAR_inspector_0_0);
    Array PThreadedCode4696 = instantiate_Array_with(ThreadedCode_Class, 0, 13, (Optr)&t_push_self, (Optr)&t_send0, (Optr)PSend4697, (Optr)&t_send0, (Optr)PSend4698, (Optr)&t_send0, (Optr)PSend4699, (Optr)&t_push_self, (Optr)&t_push_variable, (Optr)VAR_inspector_0_0, (Optr)&t_send2, (Optr)PSend4700, (Optr)&t_method_return);
    Method PMethod4694 = new_Method_with(PArray4695, empty_Array, empty_Array, PThreadedCode4696, 1, PSend4700);
    
    MethodClosure MC_SMB_inspectChildrenOn_ = new_MethodClosure((Method)PMethod4694, ReflectionMethod_Class);
...
static void init_SMB_accept_on_message_boundBy_() {
    ...
    Array PArray4702 = new_Array_with(4, (Optr)VAR_visitor_0_0, (Optr)VAR_receiver_0_1, (Optr)VAR_message_0_2, (Optr)VAR_closure_0_3);
    ...
    Send PSend4704 = new_Send((Optr)VAR_visitor_0_0, SMB_invokeReflectionMethod_on_message_, 3, (Optr)VAR_closure_0_3, (Optr)VAR_receiver_0_1, (Optr)VAR_message_0_2);
    Array PThreadedCode4703 = instantiate_Array_with(ThreadedCode_Class, 0, 11, (Optr)&t_push_variable, (Optr)VAR_visitor_0_0, (Optr)&t_push_variable, (Optr)VAR_closure_0_3, (Optr)&t_push_variable, (Optr)VAR_receiver_0_1, (Optr)&t_push_variable, (Optr)VAR_message_0_2, (Optr)&t_send3, (Optr)PSend4704, (Optr)&t_method_return);
    Method PMethod4701 = new_Method_with(PArray4702, empty_Array, empty_Array, PThreadedCode4703, 1, PSend4704);
    
    MethodClosure MC_SMB_accept_on_message_boundBy_ = new_MethodClosure((Method)PMethod4701, ReflectionMethod_Class);
...
static void init_SMB_accept_() {
    ...
    Variable VAR_visitor_0_0 = new_Variable_named(L"visitor", 0);
    Array PArray4706 = new_Array_with(1, (Optr)VAR_visitor_0_0);
    Symbol SMB_visitReflectionMethod_ = new_Symbol(L"visitReflectionMethod:");
    // visitReflectionMethod:. 
    Send PSend4708 = new_Send((Optr)VAR_visitor_0_0, SMB_visitReflectionMethod_, 1, (Optr)self);
    Array PThreadedCode4707 = instantiate_Array_with(ThreadedCode_Class, 0, 6, (Optr)&t_push_variable, (Optr)VAR_visitor_0_0, (Optr)&t_push_self, (Optr)&t_send1, (Optr)PSend4708, (Optr)&t_method_return);
    Method PMethod4705 = new_Method_with(PArray4706, empty_Array, empty_Array, PThreadedCode4707, 1, PSend4708);
    
    MethodClosure MC_SMB_accept_ = new_MethodClosure((Method)PMethod4705, ReflectionMethod_Class);
