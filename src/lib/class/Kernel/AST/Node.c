...
static void init_SMB_isScoped() {
    ...
    Array PThreadedCode4106 = instantiate_Array_with(ThreadedCode_Class, 0, 1, (Optr)&t_method_return_true);
    Method PMethod4105 = new_Method_with(empty_Array, empty_Array, empty_Array, PThreadedCode4106, 1, true_Const);
    
    MethodClosure MC_SMB_isScoped = new_MethodClosure((Method)PMethod4105, Kernel_AST_Node_Class);
...
static void init_SMB_asNode() {
    ...
    Array PThreadedCode4108 = instantiate_Array_with(ThreadedCode_Class, 0, 1, (Optr)&t_method_return_self);
    Method PMethod4107 = new_Method_with(empty_Array, empty_Array, empty_Array, PThreadedCode4108, 1, self);
    
    MethodClosure MC_SMB_asNode = new_MethodClosure((Method)PMethod4107, Kernel_AST_Node_Class);
