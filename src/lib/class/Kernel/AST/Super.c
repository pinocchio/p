...
static void init_SMB_accept_() {
    ...
    Array PArray4843 = new_Array_with(1, (Optr)VAR_visitor_0_0);
    Symbol SMB_visitSuper_ = new_Symbol(L"visitSuper:");
    // visitSuper:. 
    Send PSend4845 = new_Send((Optr)VAR_visitor_0_0, SMB_visitSuper_, 1, (Optr)self);
    Array PThreadedCode4844 = instantiate_Array_with(ThreadedCode_Class, 0, 6, (Optr)&t_push_variable, (Optr)VAR_visitor_0_0, (Optr)&t_push_self, (Optr)&t_send1, (Optr)PSend4845, (Optr)&t_method_return);
    Method PMethod4842 = new_Method_with(PArray4843, empty_Array, empty_Array, PThreadedCode4844, 1, PSend4845);
    
    MethodClosure MC_SMB_accept_ = new_MethodClosure((Method)PMethod4842, Super_Class);
