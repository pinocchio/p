...
static void init_SMB_accept_on_message_boundBy_() {
    ...
    Array PArray4712 = new_Array_with(4, (Optr)VAR_visitor_0_0, (Optr)VAR_receiver_0_1, (Optr)VAR_message_0_2, (Optr)VAR_closure_0_3);
    Symbol SMB_invokeMethod_on_message_ = new_Symbol(L"invokeMethod:on:message:");
    // invokeMethod:on:message:. 
    Send PSend4714 = new_Send((Optr)VAR_visitor_0_0, SMB_invokeMethod_on_message_, 3, (Optr)VAR_closure_0_3, (Optr)VAR_receiver_0_1, (Optr)VAR_message_0_2);
    Array PThreadedCode4713 = instantiate_Array_with(ThreadedCode_Class, 0, 11, (Optr)&t_push_variable, (Optr)VAR_visitor_0_0, (Optr)&t_push_variable, (Optr)VAR_closure_0_3, (Optr)&t_push_variable, (Optr)VAR_receiver_0_1, (Optr)&t_push_variable, (Optr)VAR_message_0_2, (Optr)&t_send3, (Optr)PSend4714, (Optr)&t_method_return);
    Method PMethod4711 = new_Method_with(PArray4712, empty_Array, empty_Array, PThreadedCode4713, 1, PSend4714);
    
    MethodClosure MC_SMB_accept_on_message_boundBy_ = new_MethodClosure((Method)PMethod4711, Method_Class);
...
static void init_SMB_accept_() {
    ...
    Variable VAR_visitor_0_0 = new_Variable_named(L"visitor", 0);
    Array PArray4716 = new_Array_with(1, (Optr)VAR_visitor_0_0);
    Symbol SMB_visitMethod_ = new_Symbol(L"visitMethod:");
    // visitMethod:. 
    Send PSend4718 = new_Send((Optr)VAR_visitor_0_0, SMB_visitMethod_, 1, (Optr)self);
    Array PThreadedCode4717 = instantiate_Array_with(ThreadedCode_Class, 0, 6, (Optr)&t_push_variable, (Optr)VAR_visitor_0_0, (Optr)&t_push_self, (Optr)&t_send1, (Optr)PSend4718, (Optr)&t_method_return);
    Method PMethod4715 = new_Method_with(PArray4716, empty_Array, empty_Array, PThreadedCode4717, 1, PSend4718);
    
    MethodClosure MC_SMB_accept_ = new_MethodClosure((Method)PMethod4715, Method_Class);
