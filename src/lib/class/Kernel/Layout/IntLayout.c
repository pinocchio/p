...
static void init_SMB_do_() {
    ...
    Array PArray5177 = new_Array_with(1, (Optr)VAR_aBlock_0_0);
    Array PThreadedCode5178 = instantiate_Array_with(ThreadedCode_Class, 0, 1, (Optr)&t_method_return_self);
    Method PMethod5176 = new_Method_with(PArray5177, empty_Array, empty_Array, PThreadedCode5178, 1, self);
    
    MethodClosure MC_SMB_do_ = new_MethodClosure((Method)PMethod5176, IntLayout_Class);
