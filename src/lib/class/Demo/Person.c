...
static void init_SMB_name_() {
    ...
    Assign PAssign24504 = new_Assign((Optr)slot_Demo_Person_name, (Optr)VAR_anObject_0_0);
    ...
    MethodClosure MC_SMB_name_ = new_MethodClosure((Method)PMethod24501, Demo_Person_Class);
...
static void init_SMB_name() {
    ...
    Array PThreadedCode24506 = instantiate_Array_with(ThreadedCode_Class, 0, 3, (Optr)&t_push_slot, (Optr)slot_Demo_Person_name, (Optr)&t_method_return);
    Method PMethod24505 = new_Method_with(empty_Array, empty_Array, empty_Array, PThreadedCode24506, 1, slot_Demo_Person_name);
    
    MethodClosure MC_SMB_name = new_MethodClosure((Method)PMethod24505, Demo_Person_Class);
