...
static void init_SMB_name_() {
    ...
    Array PArray24538 = new_Array_with(1, (Optr)VAR_anObject_0_0);
    Assign PAssign24540 = new_Assign((Optr)slot_Demo_Person_name, (Optr)VAR_anObject_0_0);
    Array PThreadedCode24539 = instantiate_Array_with(ThreadedCode_Class, 0, 7, (Optr)&t_push1, (Optr)PAssign24540, (Optr)&t_push_variable, (Optr)VAR_anObject_0_0, (Optr)&t_assign, (Optr)&t_zap, (Optr)&t_method_return_self);
    Method PMethod24537 = new_Method_with(PArray24538, empty_Array, empty_Array, PThreadedCode24539, 2, PAssign24540, self);
    
    MethodClosure MC_SMB_name_ = new_MethodClosure((Method)PMethod24537, Demo_Person_Class);
...
static void init_SMB_name() {
    ...
    Array PThreadedCode24542 = instantiate_Array_with(ThreadedCode_Class, 0, 3, (Optr)&t_push_slot, (Optr)slot_Demo_Person_name, (Optr)&t_method_return);
    Method PMethod24541 = new_Method_with(empty_Array, empty_Array, empty_Array, PThreadedCode24542, 1, slot_Demo_Person_name);
    
    MethodClosure MC_SMB_name = new_MethodClosure((Method)PMethod24541, Demo_Person_Class);
