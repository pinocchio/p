...
static void init_SMB_printOn_() {
    ...
    String string_21318 = new_String(L"a Week starting: ");
    Constant string_21318_Const = new_Constant((Optr)string_21318);
    // printOn:. 
    Send PSend21319 = new_Send((Optr)string_21318_Const, SMB_printOn_, 1, (Optr)VAR_aStream_0_0);
    Symbol SMB_start = new_Symbol(L"start");
    // start. 
    Send PSend21320 = new_Send((Optr)self, SMB_start, 0);
    // printOn:. 
    Send PSend21321 = new_Send((Optr)PSend21320, SMB_printOn_, 1, (Optr)VAR_aStream_0_0);
    Array PThreadedCode21317 = instantiate_Array_with(ThreadedCode_Class, 0, 16, (Optr)&t_push1, (Optr)string_21318, (Optr)&t_push_variable, (Optr)VAR_aStream_0_0, (Optr)&t_send1, (Optr)PSend21319, (Optr)&t_zap, (Optr)&t_push_self, (Optr)&t_send0, (Optr)PSend21320, (Optr)&t_push_variable, (Optr)VAR_aStream_0_0, (Optr)&t_send1, (Optr)PSend21321, (Optr)&t_zap, (Optr)&t_method_return_self);
    Method PMethod21315 = new_Method_with(PArray21316, empty_Array, empty_Array, PThreadedCode21317, 3, PSend21319, PSend21321, self);
    
    MethodClosure MC_SMB_printOn_ = new_MethodClosure((Method)PMethod21315, Chronology_Week_Class);
...
static void init_class_SMB_nameOfDay_() {
    ...
    Array PArray21323 = new_Array_with(1, (Optr)VAR_anIndex_0_0);
    Symbol SMB_dayNames = new_Symbol(L"dayNames");
    // dayNames. 
    Send PSend21325 = new_Send((Optr)PChronologyConstants_classReference, SMB_dayNames, 0);
    Symbol SMB_at_ = new_Symbol(L"at:");
    // at:. 
    Send PSend21326 = new_Send((Optr)PSend21325, SMB_at_, 1, (Optr)VAR_anIndex_0_0);
    Array PThreadedCode21324 = instantiate_Array_with(ThreadedCode_Class, 0, 9, (Optr)&t_push_class_reference, (Optr)PChronologyConstants_classReference, (Optr)&t_send0, (Optr)PSend21325, (Optr)&t_push_variable, (Optr)VAR_anIndex_0_0, (Optr)&t_send1, (Optr)PSend21326, (Optr)&t_method_return);
    Method PMethod21322 = new_Method_with(PArray21323, empty_Array, empty_Array, PThreadedCode21324, 1, PSend21326);
    
    MethodClosure MC_SMB_nameOfDay_ = new_MethodClosure((Method)PMethod21322, HEADER(Chronology_Week_Class));
