...
static void init_SMB_message() {
    ...
    String string_21729 = new_String(L"Classes are not nested");
    Array PThreadedCode21728 = instantiate_Array_with(ThreadedCode_Class, 0, 3, (Optr)&t_push1, (Optr)string_21729, (Optr)&t_method_return);
    Constant string_21729_Const = new_Constant((Optr)string_21729);
    Method PMethod21727 = new_Method_with(empty_Array, empty_Array, empty_Array, PThreadedCode21728, 1, string_21729_Const);
    
    MethodClosure MC_SMB_message = new_MethodClosure((Method)PMethod21727, Organization_NestedClassException_Class);
