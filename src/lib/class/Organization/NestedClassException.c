...
static void init_SMB_message() {
    ...
    String string_22410 = new_String(L"Classes are not nested");
    Array PThreadedCode22409 = instantiate_Array_with(ThreadedCode_Class, 0, 3, (Optr)&t_push1, (Optr)string_22410, (Optr)&t_method_return);
    Constant string_22410_Const = new_Constant((Optr)string_22410);
    Method PMethod22408 = new_Method_with(empty_Array, empty_Array, empty_Array, PThreadedCode22409, 1, string_22410_Const);
    
    MethodClosure MC_SMB_message = new_MethodClosure((Method)PMethod22408, Organization_NestedClassException_Class);
