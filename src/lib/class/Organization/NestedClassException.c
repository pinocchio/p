...
static void init_SMB_message() {
    ...
    String string_21889 = new_String(L"Classes are not nested");
    Array PThreadedCode21888 = instantiate_Array_with(ThreadedCode_Class, 0, 3, (Optr)&t_push1, (Optr)string_21889, (Optr)&t_method_return);
    Constant string_21889_Const = new_Constant((Optr)string_21889);
    Method PMethod21887 = new_Method_with(empty_Array, empty_Array, empty_Array, PThreadedCode21888, 1, string_21889_Const);
    
    MethodClosure MC_SMB_message = new_MethodClosure((Method)PMethod21887, Organization_NestedClassException_Class);
