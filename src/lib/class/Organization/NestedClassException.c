...
static void init_SMB_message() {
    ...
    String string_22089 = new_String(L"Classes are not nested");
    Array PThreadedCode22088 = instantiate_Array_with(ThreadedCode_Class, 0, 3, (Optr)&t_push1, (Optr)string_22089, (Optr)&t_method_return);
    Constant string_22089_Const = new_Constant((Optr)string_22089);
    Method PMethod22087 = new_Method_with(empty_Array, empty_Array, empty_Array, PThreadedCode22088, 1, string_22089_Const);
    
    MethodClosure MC_SMB_message = new_MethodClosure((Method)PMethod22087, Organization_NestedClassException_Class);
