...
(define symbols
     '((eval                    "EVAL")
       (eval:                   "PRE_EVAL_ENV")
       (store:at:in:            "STORE_AT_IN")
       (subScope:key:           "SUBSCOPE_KEY")
       (scope:key:              "SCOPE_KEY")
       (parent:                 "SET_PARENT")
       (parent                  "PARENT")
       (size:                   "WITH_SIZE")
       ...
       (scope                   "SCOPE")
       (objectAt:               "OBJECT_AT")
       (objectAt:put:           "OBJECT_AT_PUT")
       (basicNew                "NEW")
       (basicNew:               "SIZED")
       (delegate                "DELEGATE")
       (dispatch:delegate:      "SET_DISPATCH_DELEGATE")
       (size                    "SIZE")
       (dispatch:delegate:size: "DISPATCH_DELEGATE_SIZE")
       (shift                   "SHIFT")
       (instance                "INSTANCE")
       (to:expression:          "TO_EXPRESSION")
       (to:sized:               "TO_SIZED")
       (on:                     "ON")
       (readChar                "READ")
       (writeChar:              "WRITE")
       (atEnd                   "END")
       (readAllChars            "READ_ALL")
      ))
...
(define natives
  '((+              "scheme_plus")
    ...
    (cons?          "scheme_consp")
    (error          "scheme_error")
    (error_handler  "scheme_error_handler")
